...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"test_component_base.HierarchyA"))
    {
        return winrt::detach_abi(winrt::make<winrt::test_component_base::factory_implementation::HierarchyA>());
    }

    if (requal(name, L"test_component_base.HierarchyB"))
    {
        return winrt::detach_abi(winrt::make<winrt::test_component_base::factory_implementation::HierarchyB>());
    }
