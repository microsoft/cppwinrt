...
namespace
{
    template <typename A, typename B> void test_sequence(A const& container, std::initializer_list<B> expected)
    {
    ...
    struct simple_iterable : implements<simple_iterable, IIterable<int>>, iterable_base<simple_iterable, int>
    {
...
namespace
{
    ...
    struct agile_iterable : implements<agile_iterable, IIterable<IStringable>>, iterable_base<agile_iterable, IStringable>
    {
        auto& get_container() const noexcept
        {
            return m_values;
...
namespace
{
    struct agile_iterable_pair : implements<agile_iterable_pair, IIterable<IKeyValuePair<hstring, IStringable>>>,
                                 iterable_base<agile_iterable_pair, IKeyValuePair<hstring, IStringable>>
    {
        ...
        std::map<std::wstring, agile_ref<IStringable>> m_values{ { L"one", make<stringable>(L"one") },
