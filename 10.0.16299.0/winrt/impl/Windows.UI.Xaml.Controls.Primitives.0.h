...
{
    Windows::Foundation::Rect ClipRect() const noexcept;
    double CompactVerticalDelta() const noexcept;
    Windows::UI::Xaml::Thickness CompactRootMargin() const noexcept;
    double MinimalVerticalDelta() const noexcept;
    Windows::UI::Xaml::Thickness MinimalRootMargin() const noexcept;
    double HiddenVerticalDelta() const noexcept;
    Windows::UI::Xaml::Thickness HiddenRootMargin() const noexcept;
};
...
{
    Windows::UI::Xaml::Controls::ClickMode ClickMode() const noexcept;
    void ClickMode(Windows::UI::Xaml::Controls::ClickMode const& value) const noexcept;
    bool IsPointerOver() const noexcept;
    bool IsPressed() const noexcept;
    Windows::UI::Xaml::Input::ICommand Command() const noexcept;
    void Command(Windows::UI::Xaml::Input::ICommand const& value) const noexcept;
    Windows::Foundation::IInspectable CommandParameter() const noexcept;
    void CommandParameter(Windows::Foundation::IInspectable const& value) const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty ClickModeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsPointerOverProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsPressedProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CommandProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CommandParameterProperty() const noexcept;
};
...
{
    double MinViewWidth() const noexcept;
    hstring HeaderText() const noexcept;
    hstring WeekDay1() const noexcept;
    hstring WeekDay2() const noexcept;
    hstring WeekDay3() const noexcept;
    hstring WeekDay4() const noexcept;
    hstring WeekDay5() const noexcept;
    hstring WeekDay6() const noexcept;
    hstring WeekDay7() const noexcept;
    bool HasMoreContentAfter() const noexcept;
    bool HasMoreContentBefore() const noexcept;
    bool HasMoreViews() const noexcept;
    Windows::Foundation::Rect ClipRect() const noexcept;
...
struct consume_Windows_UI_Xaml_Controls_Primitives_ICarouselPanel
{
    ...
    void CanVerticallyScroll(bool value) const noexcept;
    bool CanHorizontallyScroll() const noexcept;
    void CanHorizontallyScroll(bool value) const noexcept;
    ...
    Windows::Foundation::IInspectable ScrollOwner() const noexcept;
    void ScrollOwner(Windows::Foundation::IInspectable const& value) const noexcept;
    void LineUp() const;
    void LineDown() const;
    void LineLeft() const;
...
{
    Windows::UI::Xaml::Controls::ColorPickerHsvChannel ColorChannel() const noexcept;
    void ColorChannel(Windows::UI::Xaml::Controls::ColorPickerHsvChannel const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty ColorChannelProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Controls_Primitives_IColorSpectrum
{
    ...
    Windows::Foundation::Numerics::float4 HsvColor() const noexcept;
    void HsvColor(Windows::Foundation::Numerics::float4 const& value) const noexcept;
    int32_t MinHue() const noexcept;
    void MinHue(int32_t value) const noexcept;
    int32_t MaxHue() const noexcept;
    void MaxHue(int32_t value) const noexcept;
    int32_t MinSaturation() const noexcept;
    void MinSaturation(int32_t value) const noexcept;
    int32_t MaxSaturation() const noexcept;
    void MaxSaturation(int32_t value) const noexcept;
    int32_t MinValue() const noexcept;
    void MinValue(int32_t value) const noexcept;
    int32_t MaxValue() const noexcept;
    void MaxValue(int32_t value) const noexcept;
    Windows::UI::Xaml::Controls::ColorSpectrumShape Shape() const noexcept;
    void Shape(Windows::UI::Xaml::Controls::ColorSpectrumShape const& value) const noexcept;
    Windows::UI::Xaml::Controls::ColorSpectrumComponents Components() const noexcept;
    void Components(Windows::UI::Xaml::Controls::ColorSpectrumComponents const& value) const noexcept;
...
struct consume_Windows_UI_Xaml_Controls_Primitives_IColorSpectrumStatics
{
    ...
    Windows::UI::Xaml::DependencyProperty HsvColorProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MinHueProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MaxHueProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MinSaturationProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MaxSaturationProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MinValueProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MaxValueProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ShapeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ComponentsProperty() const noexcept;
};
...
{
    double DropDownOpenedHeight() const noexcept;
    double DropDownClosedHeight() const noexcept;
    double DropDownOffset() const noexcept;
    Windows::UI::Xaml::Controls::Primitives::AnimationDirection SelectedItemDirection() const noexcept;
};
...
{
    double DropDownContentMinWidth() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Controls_Primitives_ICommandBarTemplateSettings
{
    ...
    Windows::Foundation::Rect OverflowContentClipRect() const noexcept;
    double OverflowContentMinWidth() const noexcept;
    double OverflowContentMaxHeight() const noexcept;
    double OverflowContentHorizontalOffset() const noexcept;
    double OverflowContentHeight() const noexcept;
    double NegativeOverflowContentHeight() const noexcept;
};
...
{
    double OverflowContentMaxWidth() const noexcept;
};
...
{
    Windows::UI::Xaml::Visibility EffectiveOverflowButtonVisibility() const noexcept;
};
...
{
    double HorizontalChange() const noexcept;
    double VerticalChange() const noexcept;
...
{
    Windows::UI::Xaml::Controls::Primitives::FlyoutPlacementMode Placement() const noexcept;
    void Placement(Windows::UI::Xaml::Controls::Primitives::FlyoutPlacementMode const& value) const noexcept;
...
{
    Windows::UI::Xaml::FrameworkElement Target() const noexcept;
    bool AllowFocusOnInteraction() const noexcept;
    void AllowFocusOnInteraction(bool value) const noexcept;
    Windows::UI::Xaml::Controls::LightDismissOverlayMode LightDismissOverlayMode() const noexcept;
    void LightDismissOverlayMode(Windows::UI::Xaml::Controls::LightDismissOverlayMode const& value) const noexcept;
    bool AllowFocusWhenDisabled() const noexcept;
    void AllowFocusWhenDisabled(bool value) const noexcept;
...
{
    Windows::UI::Xaml::DependencyObject OverlayInputPassThroughElement() const noexcept;
    void OverlayInputPassThroughElement(Windows::UI::Xaml::DependencyObject const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty PlacementProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty AttachedFlyoutProperty() const noexcept;
...
struct consume_Windows_UI_Xaml_Controls_Primitives_IFlyoutBaseStatics2
{
    ...
    Windows::UI::Xaml::DependencyProperty LightDismissOverlayModeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty AllowFocusWhenDisabledProperty() const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty OverlayInputPassThroughElementProperty() const noexcept;
};
...
{
    bool SelectionCheckMarkVisualEnabled() const noexcept;
    void SelectionCheckMarkVisualEnabled(bool value) const noexcept;
    Windows::UI::Xaml::Media::Brush CheckHintBrush() const noexcept;
    void CheckHintBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush CheckSelectingBrush() const noexcept;
    void CheckSelectingBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush CheckBrush() const noexcept;
    void CheckBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush DragBackground() const noexcept;
    void DragBackground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush DragForeground() const noexcept;
    void DragForeground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush FocusBorderBrush() const noexcept;
    void FocusBorderBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush PlaceholderBackground() const noexcept;
    void PlaceholderBackground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush PointerOverBackground() const noexcept;
    void PointerOverBackground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush SelectedBackground() const noexcept;
    void SelectedBackground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush SelectedForeground() const noexcept;
    void SelectedForeground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush SelectedPointerOverBackground() const noexcept;
    void SelectedPointerOverBackground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush SelectedPointerOverBorderBrush() const noexcept;
    void SelectedPointerOverBorderBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Thickness SelectedBorderThickness() const noexcept;
    void SelectedBorderThickness(Windows::UI::Xaml::Thickness const& value) const noexcept;
    double DisabledOpacity() const noexcept;
    void DisabledOpacity(double value) const noexcept;
    double DragOpacity() const noexcept;
    void DragOpacity(double value) const noexcept;
    double ReorderHintOffset() const noexcept;
    void ReorderHintOffset(double value) const noexcept;
    [[deprecated("Use ContentPresenter.HorizontalContentAlignment instead of GridViewItemPresenterHorizontalContentAlignment. For more info, see MSDN.")]] Windows::UI::Xaml::HorizontalAlignment GridViewItemPresenterHorizontalContentAlignment() const noexcept;
    [[deprecated("Use ContentPresenter.HorizontalContentAlignment instead of GridViewItemPresenterHorizontalContentAlignment. For more info, see MSDN.")]] void GridViewItemPresenterHorizontalContentAlignment(Windows::UI::Xaml::HorizontalAlignment const& value) const noexcept;
    [[deprecated("Use ContentPresenter.VerticalContentAlignment instead of GridViewItemPresenterVerticalContentAlignment. For more info, see MSDN.")]] Windows::UI::Xaml::VerticalAlignment GridViewItemPresenterVerticalContentAlignment() const noexcept;
    [[deprecated("Use ContentPresenter.VerticalContentAlignment instead of GridViewItemPresenterVerticalContentAlignment. For more info, see MSDN.")]] void GridViewItemPresenterVerticalContentAlignment(Windows::UI::Xaml::VerticalAlignment const& value) const noexcept;
    [[deprecated("Use ContentPresenter.Padding instead of GridViewItemPresenterPadding. For more info, see MSDN.")]] Windows::UI::Xaml::Thickness GridViewItemPresenterPadding() const noexcept;
    [[deprecated("Use ContentPresenter.Padding instead of GridViewItemPresenterPadding. For more info, see MSDN.")]] void GridViewItemPresenterPadding(Windows::UI::Xaml::Thickness const& value) const noexcept;
    Windows::UI::Xaml::Thickness PointerOverBackgroundMargin() const noexcept;
    void PointerOverBackgroundMargin(Windows::UI::Xaml::Thickness const& value) const noexcept;
    Windows::UI::Xaml::Thickness ContentMargin() const noexcept;
    void ContentMargin(Windows::UI::Xaml::Thickness const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty SelectionCheckMarkVisualEnabledProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CheckHintBrushProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CheckSelectingBrushProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CheckBrushProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty DragBackgroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty DragForegroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty FocusBorderBrushProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty PlaceholderBackgroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty PointerOverBackgroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedBackgroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedForegroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedPointerOverBackgroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedPointerOverBorderBrushProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedBorderThicknessProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty DisabledOpacityProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty DragOpacityProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ReorderHintOffsetProperty() const noexcept;
    [[deprecated("Use ContentPresenter.HorizontalContentAlignment instead of GridViewItemPresenterHorizontalContentAlignment. For more info, see MSDN.")]] Windows::UI::Xaml::DependencyProperty GridViewItemPresenterHorizontalContentAlignmentProperty() const noexcept;
    [[deprecated("Use ContentPresenter.VerticalContentAlignment instead of GridViewItemPresenterVerticalContentAlignment. For more info, see MSDN.")]] Windows::UI::Xaml::DependencyProperty GridViewItemPresenterVerticalContentAlignmentProperty() const noexcept;
    [[deprecated("Use ContentPresenter.Padding instead of GridViewItemPresenterPadding. For more info, see MSDN.")]] Windows::UI::Xaml::DependencyProperty GridViewItemPresenterPaddingProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty PointerOverBackgroundMarginProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ContentMarginProperty() const noexcept;
};
...
{
    int32_t DragItemsCount() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Controls_Primitives_IItemsChangedEventArgs
{
    ...
    Windows::UI::Xaml::Controls::Primitives::GeneratorPosition Position() const noexcept;
    Windows::UI::Xaml::Controls::Primitives::GeneratorPosition OldPosition() const noexcept;
    int32_t ItemCount() const noexcept;
    int32_t ItemUICount() const noexcept;
};
...
{
    Windows::UI::Xaml::Media::Brush Enabled() const noexcept;
    void Enabled(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush Disabled() const noexcept;
    void Disabled(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty EnabledProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty DisabledProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Controls_Primitives_IListViewItemPresenter
{
    ...
    double ReorderHintOffset() const noexcept;
    void ReorderHintOffset(double value) const noexcept;
    [[deprecated("Use ContentPresenter.HorizontalContentAlignment instead of ListViewItemPresenterHorizontalContentAlignment. For more info, see MSDN.")]] Windows::UI::Xaml::HorizontalAlignment ListViewItemPresenterHorizontalContentAlignment() const noexcept;
    [[deprecated("Use ContentPresenter.HorizontalContentAlignment instead of ListViewItemPresenterHorizontalContentAlignment. For more info, see MSDN.")]] void ListViewItemPresenterHorizontalContentAlignment(Windows::UI::Xaml::HorizontalAlignment const& value) const noexcept;
    [[deprecated("Use ContentPresenter.VerticalContentAlignment instead of ListViewItemPresenterVerticalContentAlignment. For more info, see MSDN.")]] Windows::UI::Xaml::VerticalAlignment ListViewItemPresenterVerticalContentAlignment() const noexcept;
    [[deprecated("Use ContentPresenter.VerticalContentAlignment instead of ListViewItemPresenterVerticalContentAlignment. For more info, see MSDN.")]] void ListViewItemPresenterVerticalContentAlignment(Windows::UI::Xaml::VerticalAlignment const& value) const noexcept;
    [[deprecated("Use ContentPresenter.Padding instead of GridViewItemPresenterPadding. For more info, see MSDN.")]] Windows::UI::Xaml::Thickness ListViewItemPresenterPadding() const noexcept;
    [[deprecated("Use ContentPresenter.Padding instead of GridViewItemPresenterPadding. For more info, see MSDN.")]] void ListViewItemPresenterPadding(Windows::UI::Xaml::Thickness const& value) const noexcept;
    Windows::UI::Xaml::Thickness PointerOverBackgroundMargin() const noexcept;
    void PointerOverBackgroundMargin(Windows::UI::Xaml::Thickness const& value) const noexcept;
    Windows::UI::Xaml::Thickness ContentMargin() const noexcept;
    void ContentMargin(Windows::UI::Xaml::Thickness const& value) const noexcept;
...
{
    Windows::UI::Xaml::Media::Brush SelectedPressedBackground() const noexcept;
    void SelectedPressedBackground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush PressedBackground() const noexcept;
    void PressedBackground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush CheckBoxBrush() const noexcept;
    void CheckBoxBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush FocusSecondaryBorderBrush() const noexcept;
    void FocusSecondaryBorderBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Controls::Primitives::ListViewItemPresenterCheckMode CheckMode() const noexcept;
    void CheckMode(Windows::UI::Xaml::Controls::Primitives::ListViewItemPresenterCheckMode const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush PointerOverForeground() const noexcept;
    void PointerOverForeground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::Media::Brush RevealBackground() const noexcept;
    void RevealBackground(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush RevealBorderBrush() const noexcept;
    void RevealBorderBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Thickness RevealBorderThickness() const noexcept;
    void RevealBorderThickness(Windows::UI::Xaml::Thickness const& value) const noexcept;
    bool RevealBackgroundShowsAboveContent() const noexcept;
    void RevealBackgroundShowsAboveContent(bool value) const noexcept;
};
...
struct consume_Windows_UI_Xaml_Controls_Primitives_IListViewItemPresenterStatics
{
    ...
    Windows::UI::Xaml::DependencyProperty DragOpacityProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ReorderHintOffsetProperty() const noexcept;
    [[deprecated("Use ContentPresenter.HorizontalContentAlignment instead of ListViewItemPresenterHorizontalContentAlignment. For more info, see MSDN.")]] Windows::UI::Xaml::DependencyProperty ListViewItemPresenterHorizontalContentAlignmentProperty() const noexcept;
    [[deprecated("Use ContentPresenter.VerticalContentAlignment instead of ListViewItemPresenterVerticalContentAlignment. For more info, see MSDN.")]] Windows::UI::Xaml::DependencyProperty ListViewItemPresenterVerticalContentAlignmentProperty() const noexcept;
    [[deprecated("Use ContentPresenter.Padding instead of GridViewItemPresenterPadding. For more info, see MSDN.")]] Windows::UI::Xaml::DependencyProperty ListViewItemPresenterPaddingProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty PointerOverBackgroundMarginProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ContentMarginProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty SelectedPressedBackgroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty PressedBackgroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CheckBoxBrushProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty FocusSecondaryBorderBrushProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CheckModeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty PointerOverForegroundProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty RevealBackgroundProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RevealBorderBrushProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RevealBorderThicknessProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RevealBackgroundShowsAboveContentProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Controls_Primitives_ILoopingSelector
{
    ...
    void ShouldLoop(bool value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Foundation::IInspectable> Items() const noexcept;
    void Items(param::vector<Windows::Foundation::IInspectable> const& value) const noexcept;
    int32_t SelectedIndex() const noexcept;
    void SelectedIndex(int32_t value) const noexcept;
    Windows::Foundation::IInspectable SelectedItem() const noexcept;
    void SelectedItem(Windows::Foundation::IInspectable const& value) const noexcept;
    int32_t ItemWidth() const noexcept;
    void ItemWidth(int32_t value) const noexcept;
    int32_t ItemHeight() const noexcept;
    void ItemHeight(int32_t value) const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty ShouldLoopProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ItemsProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedIndexProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedItemProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ItemWidthProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ItemHeightProperty() const noexcept;
...
{
    double FlyoutContentMinWidth() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Controls_Primitives_IPopup
{
    ...
    double HorizontalOffset() const noexcept;
    void HorizontalOffset(double value) const noexcept;
    double VerticalOffset() const noexcept;
    void VerticalOffset(double value) const noexcept;
    Windows::UI::Xaml::Media::Animation::TransitionCollection ChildTransitions() const noexcept;
    void ChildTransitions(Windows::UI::Xaml::Media::Animation::TransitionCollection const& value) const noexcept;
    bool IsLightDismissEnabled() const noexcept;
    void IsLightDismissEnabled(bool value) const noexcept;
    event_token Opened(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& value) const;
...
{
    Windows::UI::Xaml::DependencyProperty ChildProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsOpenProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty HorizontalOffsetProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty VerticalOffsetProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ChildTransitionsProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsLightDismissEnabledProperty() const noexcept;
};
...
{
    double EllipseDiameter() const noexcept;
    double EllipseOffset() const noexcept;
    double EllipseAnimationWellPosition() const noexcept;
    double EllipseAnimationEndPosition() const noexcept;
    double ContainerAnimationStartPosition() const noexcept;
    double ContainerAnimationEndPosition() const noexcept;
    double IndicatorLengthDelta() const noexcept;
};
...
{
    double EllipseDiameter() const noexcept;
    Windows::UI::Xaml::Thickness EllipseOffset() const noexcept;
    double MaxSideLength() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Controls_Primitives_IRangeBase
{
    ...
    void Minimum(double value) const noexcept;
    double Maximum() const noexcept;
    void Maximum(double value) const noexcept;
    double SmallChange() const noexcept;
    void SmallChange(double value) const noexcept;
    double LargeChange() const noexcept;
    void LargeChange(double value) const noexcept;
    double Value() const noexcept;
    void Value(double value) const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty MinimumProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MaximumProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SmallChangeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty LargeChangeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ValueProperty() const noexcept;
};
...
{
    double OldValue() const noexcept;
    double NewValue() const noexcept;
};
...
{
    int32_t Delay() const noexcept;
    void Delay(int32_t value) const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty DelayProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IntervalProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::Controls::Orientation Orientation() const noexcept;
    void Orientation(Windows::UI::Xaml::Controls::Orientation const& value) const noexcept;
    double ViewportSize() const noexcept;
    void ViewportSize(double value) const noexcept;
    Windows::UI::Xaml::Controls::Primitives::ScrollingIndicatorMode IndicatorMode() const noexcept;
    void IndicatorMode(Windows::UI::Xaml::Controls::Primitives::ScrollingIndicatorMode const& value) const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty OrientationProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ViewportSizeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IndicatorModeProperty() const noexcept;
};
...
{
    double NewValue() const noexcept;
    Windows::UI::Xaml::Controls::Primitives::ScrollEventType ScrollEventType() const noexcept;
};
...
{
    bool AreHorizontalSnapPointsRegular() const noexcept;
    bool AreVerticalSnapPointsRegular() const noexcept;
...
struct consume_Windows_UI_Xaml_Controls_Primitives_ISelector
{
    ...
    Windows::Foundation::IInspectable SelectedItem() const noexcept;
    void SelectedItem(Windows::Foundation::IInspectable const& value) const noexcept;
    Windows::Foundation::IInspectable SelectedValue() const noexcept;
    void SelectedValue(Windows::Foundation::IInspectable const& value) const noexcept;
    hstring SelectedValuePath() const noexcept;
    void SelectedValuePath(param::hstring const& value) const noexcept;
    Windows::Foundation::IReference<bool> IsSynchronizedWithCurrentItem() const noexcept;
    void IsSynchronizedWithCurrentItem(optional<bool> const& value) const noexcept;
    event_token SelectionChanged(Windows::UI::Xaml::Controls::SelectionChangedEventHandler const& value) const;
...
{
    Windows::UI::Xaml::DependencyProperty IsSelectedProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_Controls_Primitives_ISelectorStatics
{
    Windows::UI::Xaml::DependencyProperty SelectedIndexProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedItemProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedValueProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty SelectedValuePathProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsSynchronizedWithCurrentItemProperty() const noexcept;
...
{
    Windows::UI::Xaml::Media::Brush HeaderBackground() const noexcept;
    Windows::UI::Xaml::Media::Brush HeaderForeground() const noexcept;
    Windows::UI::Xaml::Media::Brush BorderBrush() const noexcept;
    Windows::UI::Xaml::Thickness BorderThickness() const noexcept;
    Windows::UI::Xaml::Media::ImageSource IconSource() const noexcept;
    Windows::UI::Xaml::Media::Animation::TransitionCollection ContentTransitions() const noexcept;
};
...
{
    double OpenPaneLength() const noexcept;
    double NegativeOpenPaneLength() const noexcept;
    double OpenPaneLengthMinusCompactLength() const noexcept;
    double NegativeOpenPaneLengthMinusCompactLength() const noexcept;
    Windows::UI::Xaml::GridLength OpenPaneGridLength() const noexcept;
    Windows::UI::Xaml::GridLength CompactPaneGridLength() const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty IsDraggingProperty() const noexcept;
};
...
{
    Windows::Foundation::IReference<bool> IsChecked() const noexcept;
    void IsChecked(optional<bool> const& value) const noexcept;
    bool IsThreeState() const noexcept;
    void IsThreeState(bool value) const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty IsCheckedProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsThreeStateProperty() const noexcept;
};
...
{
    double KnobCurrentToOnOffset() const noexcept;
    double KnobCurrentToOffOffset() const noexcept;
    double KnobOnToOffOffset() const noexcept;
    double KnobOffToOnOffset() const noexcept;
    double CurtainCurrentToOnOffset() const noexcept;
    double CurtainCurrentToOffOffset() const noexcept;
    double CurtainOnToOffOffset() const noexcept;
    double CurtainOffToOnOffset() const noexcept;
};
...
{
    double FromHorizontalOffset() const noexcept;
    double FromVerticalOffset() const noexcept;
};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IAppBarTemplateSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_CompactRootMargin(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall get_MinimalVerticalDelta(double* value) = 0;
    virtual HRESULT __stdcall get_MinimalRootMargin(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall get_HiddenVerticalDelta(double* value) = 0;
    virtual HRESULT __stdcall get_HiddenRootMargin(struct_of<32>* value) = 0;
};};

template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IButtonBase>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_ClickMode(Windows::UI::Xaml::Controls::ClickMode* value) = 0;
    virtual HRESULT __stdcall put_ClickMode(Windows::UI::Xaml::Controls::ClickMode value) = 0;
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::ICarouselPanel>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall MakeVisible(::IUnknown* visual, Windows::Foundation::Rect rectangle, Windows::Foundation::Rect* returnValue) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ColorChannel(Windows::UI::Xaml::Controls::ColorPickerHsvChannel* result) = 0;
    virtual HRESULT __stdcall put_ColorChannel(Windows::UI::Xaml::Controls::ColorPickerHsvChannel value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_ColorChannelProperty(::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IColorSpectrum>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_HsvColor(Windows::Foundation::Numerics::float4* result) = 0;
    virtual HRESULT __stdcall put_HsvColor(Windows::Foundation::Numerics::float4 value) = 0;
    virtual HRESULT __stdcall get_MinHue(int32_t* result) = 0;
    virtual HRESULT __stdcall put_MinHue(int32_t value) = 0;
    virtual HRESULT __stdcall get_MaxHue(int32_t* result) = 0;
    virtual HRESULT __stdcall put_MaxHue(int32_t value) = 0;
    virtual HRESULT __stdcall get_MinSaturation(int32_t* result) = 0;
    virtual HRESULT __stdcall put_MinSaturation(int32_t value) = 0;
    virtual HRESULT __stdcall get_MaxSaturation(int32_t* result) = 0;
    virtual HRESULT __stdcall put_MaxSaturation(int32_t value) = 0;
    virtual HRESULT __stdcall get_MinValue(int32_t* result) = 0;
    virtual HRESULT __stdcall put_MinValue(int32_t value) = 0;
    virtual HRESULT __stdcall get_MaxValue(int32_t* result) = 0;
    virtual HRESULT __stdcall put_MaxValue(int32_t value) = 0;
    virtual HRESULT __stdcall get_Shape(Windows::UI::Xaml::Controls::ColorSpectrumShape* result) = 0;
    virtual HRESULT __stdcall put_Shape(Windows::UI::Xaml::Controls::ColorSpectrumShape value) = 0;
    virtual HRESULT __stdcall get_Components(Windows::UI::Xaml::Controls::ColorSpectrumComponents* result) = 0;
    virtual HRESULT __stdcall put_Components(Windows::UI::Xaml::Controls::ColorSpectrumComponents value) = 0;
    virtual HRESULT __stdcall add_ColorChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ColorChanged(event_token token) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IColorSpectrumStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_HsvColorProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_MinHueProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_MaxHueProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_MinSaturationProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_MaxSaturationProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_MinValueProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_MaxValueProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_ShapeProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_ComponentsProperty(::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IComboBoxTemplateSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SelectedItemDirection(Windows::UI::Xaml::Controls::Primitives::AnimationDirection* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_EffectiveOverflowButtonVisibility(Windows::UI::Xaml::Visibility* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Placement(Windows::UI::Xaml::Controls::Primitives::FlyoutPlacementMode* value) = 0;
    virtual HRESULT __stdcall put_Placement(Windows::UI::Xaml::Controls::Primitives::FlyoutPlacementMode value) = 0;
    ...
    virtual HRESULT __stdcall add_Closed(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Closed(event_token token) = 0;
    virtual HRESULT __stdcall add_Opening(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IFlyoutBase2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_LightDismissOverlayMode(Windows::UI::Xaml::Controls::LightDismissOverlayMode* value) = 0;
    virtual HRESULT __stdcall put_LightDismissOverlayMode(Windows::UI::Xaml::Controls::LightDismissOverlayMode value) = 0;
    ...
    virtual HRESULT __stdcall add_Closing(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall TryInvokeKeyboardAccelerator(::IUnknown* args) = 0;
};};
...
{
    virtual HRESULT __stdcall OnProcessKeyboardAccelerators(::IUnknown* args) = 0;
};};
...
{
    virtual HRESULT __stdcall FromIndexAndOffset(int32_t index, int32_t offset, struct_of<8>* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IGridViewItemPresenter>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_SelectedBorderThickness(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_SelectedBorderThickness(struct_of<32> value) = 0;
    ...
    virtual HRESULT __stdcall get_GridViewItemPresenterHorizontalContentAlignment(Windows::UI::Xaml::HorizontalAlignment* value) = 0;
    virtual HRESULT __stdcall put_GridViewItemPresenterHorizontalContentAlignment(Windows::UI::Xaml::HorizontalAlignment value) = 0;
    virtual HRESULT __stdcall get_GridViewItemPresenterVerticalContentAlignment(Windows::UI::Xaml::VerticalAlignment* value) = 0;
    virtual HRESULT __stdcall put_GridViewItemPresenterVerticalContentAlignment(Windows::UI::Xaml::VerticalAlignment value) = 0;
    virtual HRESULT __stdcall get_GridViewItemPresenterPadding(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_GridViewItemPresenterPadding(struct_of<32> value) = 0;
    virtual HRESULT __stdcall get_PointerOverBackgroundMargin(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_PointerOverBackgroundMargin(struct_of<32> value) = 0;
    virtual HRESULT __stdcall get_ContentMargin(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_ContentMargin(struct_of<32> value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IItemsChangedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Position(struct_of<8>* value) = 0;
    virtual HRESULT __stdcall get_OldPosition(struct_of<8>* value) = 0;
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::ILayoutInformationStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetLayoutSlot(::IUnknown* element, Windows::Foundation::Rect* slot) = 0;
};};

template <> struct abi<Windows::UI::Xaml::Controls::Primitives::ILayoutInformationStatics2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall GetAvailableSize(::IUnknown* element, Windows::Foundation::Size* availableSize) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IListViewItemPresenter>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_ReorderHintOffset(double* value) = 0;
    virtual HRESULT __stdcall put_ReorderHintOffset(double value) = 0;
    virtual HRESULT __stdcall get_ListViewItemPresenterHorizontalContentAlignment(Windows::UI::Xaml::HorizontalAlignment* value) = 0;
    virtual HRESULT __stdcall put_ListViewItemPresenterHorizontalContentAlignment(Windows::UI::Xaml::HorizontalAlignment value) = 0;
    virtual HRESULT __stdcall get_ListViewItemPresenterVerticalContentAlignment(Windows::UI::Xaml::VerticalAlignment* value) = 0;
    virtual HRESULT __stdcall put_ListViewItemPresenterVerticalContentAlignment(Windows::UI::Xaml::VerticalAlignment value) = 0;
    virtual HRESULT __stdcall get_ListViewItemPresenterPadding(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_ListViewItemPresenterPadding(struct_of<32> value) = 0;
    virtual HRESULT __stdcall get_PointerOverBackgroundMargin(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_PointerOverBackgroundMargin(struct_of<32> value) = 0;
    virtual HRESULT __stdcall get_ContentMargin(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_ContentMargin(struct_of<32> value) = 0;
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IListViewItemPresenter2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_CheckMode(Windows::UI::Xaml::Controls::Primitives::ListViewItemPresenterCheckMode* value) = 0;
    virtual HRESULT __stdcall put_CheckMode(Windows::UI::Xaml::Controls::Primitives::ListViewItemPresenterCheckMode value) = 0;
...
{
    virtual HRESULT __stdcall get_RevealBackground(::IUnknown** value) = 0;
    virtual HRESULT __stdcall put_RevealBackground(::IUnknown* value) = 0;
    virtual HRESULT __stdcall get_RevealBorderBrush(::IUnknown** value) = 0;
    virtual HRESULT __stdcall put_RevealBorderBrush(::IUnknown* value) = 0;
    virtual HRESULT __stdcall get_RevealBorderThickness(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_RevealBorderThickness(struct_of<32> value) = 0;
    virtual HRESULT __stdcall get_RevealBackgroundShowsAboveContent(bool* value) = 0;
    virtual HRESULT __stdcall put_RevealBackgroundShowsAboveContent(bool value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_RevealBackgroundProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_RevealBorderBrushProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_RevealBorderThicknessProperty(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_RevealBackgroundShowsAboveContentProperty(::IUnknown** value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_EllipseDiameter(double* value) = 0;
    virtual HRESULT __stdcall get_EllipseOffset(struct_of<32>* value) = 0;
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IRangeBase>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ValueChanged(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Orientation(Windows::UI::Xaml::Controls::Orientation* value) = 0;
    virtual HRESULT __stdcall put_Orientation(Windows::UI::Xaml::Controls::Orientation value) = 0;
    virtual HRESULT __stdcall get_ViewportSize(double* value) = 0;
    virtual HRESULT __stdcall put_ViewportSize(double value) = 0;
    virtual HRESULT __stdcall get_IndicatorMode(Windows::UI::Xaml::Controls::Primitives::ScrollingIndicatorMode* value) = 0;
    virtual HRESULT __stdcall put_IndicatorMode(Windows::UI::Xaml::Controls::Primitives::ScrollingIndicatorMode value) = 0;
    virtual HRESULT __stdcall add_Scroll(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_NewValue(double* value) = 0;
    virtual HRESULT __stdcall get_ScrollEventType(Windows::UI::Xaml::Controls::Primitives::ScrollEventType* value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IScrollSnapPointsInfo>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_HorizontalSnapPointsChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_HorizontalSnapPointsChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_VerticalSnapPointsChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_VerticalSnapPointsChanged(event_token token) = 0;
    virtual HRESULT __stdcall GetIrregularSnapPoints(Windows::UI::Xaml::Controls::Orientation orientation, Windows::UI::Xaml::Controls::Primitives::SnapPointsAlignment alignment, ::IUnknown** returnValue) = 0;
    virtual HRESULT __stdcall GetRegularSnapPoints(Windows::UI::Xaml::Controls::Orientation orientation, Windows::UI::Xaml::Controls::Primitives::SnapPointsAlignment alignment, float* offset, float* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::ISettingsFlyoutTemplateSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_BorderThickness(struct_of<32>* value) = 0;
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::ISplitViewTemplateSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_OpenPaneGridLength(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall get_CompactPaneGridLength(struct_of<16>* value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IThumb>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_DragStarted(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DragStarted(event_token token) = 0;
    virtual HRESULT __stdcall add_DragDelta(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DragDelta(event_token token) = 0;
    virtual HRESULT __stdcall add_DragCompleted(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Xaml::Controls::Primitives::IToggleButton>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Checked(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Checked(event_token token) = 0;
    virtual HRESULT __stdcall add_Unchecked(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Unchecked(event_token token) = 0;
    virtual HRESULT __stdcall add_Indeterminate(::IUnknown* value, event_token* token) = 0;
