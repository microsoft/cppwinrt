...
{
    void LeadingEncoderPadding(optional<uint32_t> const& value) const noexcept;
    Windows::Foundation::IReference<uint32_t> LeadingEncoderPadding() const noexcept;
    void TrailingEncoderPadding(optional<uint32_t> const& value) const noexcept;
    Windows::Foundation::IReference<uint32_t> TrailingEncoderPadding() const noexcept;
};
...
struct consume_Windows_Media_Core_IAudioTrack
{
    ...
    Windows::Media::Core::AudioTrackSupportInfo SupportInfo() const noexcept;
};
...
{
    Windows::Media::Core::MediaDecoderStatus DecoderStatus() const noexcept;
    Windows::Media::Core::AudioDecoderDegradation Degradation() const noexcept;
    Windows::Media::Core::AudioDecoderDegradationReason DegradationReason() const noexcept;
    Windows::Media::Core::MediaSourceStatus MediaSourceStatus() const noexcept;
};
...
{
    Windows::Media::Core::CodecKind Kind() const noexcept;
    Windows::Media::Core::CodecCategory Category() const noexcept;
    Windows::Foundation::Collections::IVectorView<hstring> Subtypes() const noexcept;
...
{
    hstring VideoFormatDV25() const noexcept;
    hstring VideoFormatDV50() const noexcept;
    hstring VideoFormatDvc() const noexcept;
    hstring VideoFormatDvh1() const noexcept;
    hstring VideoFormatDvhD() const noexcept;
    hstring VideoFormatDvsd() const noexcept;
    hstring VideoFormatDvsl() const noexcept;
    hstring VideoFormatH263() const noexcept;
    hstring VideoFormatH264() const noexcept;
    hstring VideoFormatH265() const noexcept;
    hstring VideoFormatH264ES() const noexcept;
    hstring VideoFormatHevc() const noexcept;
    hstring VideoFormatHevcES() const noexcept;
    hstring VideoFormatM4S2() const noexcept;
    hstring VideoFormatMjpg() const noexcept;
    hstring VideoFormatMP43() const noexcept;
    hstring VideoFormatMP4S() const noexcept;
    hstring VideoFormatMP4V() const noexcept;
    hstring VideoFormatMpeg2() const noexcept;
    hstring VideoFormatVP80() const noexcept;
    hstring VideoFormatVP90() const noexcept;
    hstring VideoFormatMpg1() const noexcept;
    hstring VideoFormatMss1() const noexcept;
    hstring VideoFormatMss2() const noexcept;
    hstring VideoFormatWmv1() const noexcept;
    hstring VideoFormatWmv2() const noexcept;
    hstring VideoFormatWmv3() const noexcept;
    hstring VideoFormatWvc1() const noexcept;
    hstring VideoFormat420O() const noexcept;
    hstring AudioFormatAac() const noexcept;
    hstring AudioFormatAdts() const noexcept;
    hstring AudioFormatAlac() const noexcept;
    hstring AudioFormatAmrNB() const noexcept;
    hstring AudioFormatAmrWB() const noexcept;
    hstring AudioFormatAmrWP() const noexcept;
    hstring AudioFormatDolbyAC3() const noexcept;
    hstring AudioFormatDolbyAC3Spdif() const noexcept;
    hstring AudioFormatDolbyDDPlus() const noexcept;
    hstring AudioFormatDrm() const noexcept;
    hstring AudioFormatDts() const noexcept;
    hstring AudioFormatFlac() const noexcept;
    hstring AudioFormatFloat() const noexcept;
    hstring AudioFormatMP3() const noexcept;
    hstring AudioFormatMPeg() const noexcept;
    hstring AudioFormatMsp1() const noexcept;
    hstring AudioFormatOpus() const noexcept;
    hstring AudioFormatPcm() const noexcept;
    hstring AudioFormatWmaSpdif() const noexcept;
    hstring AudioFormatWMAudioLossless() const noexcept;
    hstring AudioFormatWMAudioV8() const noexcept;
    hstring AudioFormatWMAudioV9() const noexcept;
};
...
{
    Windows::Foundation::Collections::PropertySet Properties() const noexcept;
};
...
{
    Windows::Media::Core::FaceDetectionEffectFrame ResultFrame() const noexcept;
};
...
struct consume_Windows_Media_Core_IFaceDetectionEffect
{
    ...
    void DesiredDetectionInterval(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan DesiredDetectionInterval() const noexcept;
...
{
    void DetectionMode(Windows::Media::Core::FaceDetectionMode const& value) const noexcept;
    Windows::Media::Core::FaceDetectionMode DetectionMode() const noexcept;
    void SynchronousDetectionEnabled(bool value) const noexcept;
    bool SynchronousDetectionEnabled() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Media::FaceAnalysis::DetectedFace> DetectedFaces() const noexcept;
};
...
{
    double Certainty() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Devices::Core::FrameController> FrameControllers() const noexcept;
};
...
{
    Windows::Media::Core::TimedTextPoint Position() const noexcept;
    void Position(Windows::Media::Core::TimedTextPoint const& value) const noexcept;
    Windows::Media::Core::TimedTextSize Extent() const noexcept;
    void Extent(Windows::Media::Core::TimedTextSize const& value) const noexcept;
    void SoftwareBitmap(Windows::Graphics::Imaging::SoftwareBitmap const& value) const noexcept;
...
{
    Windows::Media::Core::MediaStreamSource Source() const noexcept;
    Windows::Storage::Streams::IRandomAccessStream RandomAccessStream() const noexcept;
...
{
    Windows::Graphics::Imaging::SoftwareBitmap Frame() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Graphics::Imaging::BitmapPixelFormat> SupportedBitmapPixelFormats() const noexcept;
    int32_t MaxSupportedFrameCount() const noexcept;
...
struct consume_Windows_Media_Core_IMediaBinder
{
    ...
    void Token(param::hstring const& value) const noexcept;
...
struct consume_Windows_Media_Core_IMediaBindingEventArgs
{
    ...
    Windows::Media::Core::MediaBinder MediaBinder() const noexcept;
    Windows::Foundation::Deferral GetDeferral() const;
...
{
    Windows::Media::Core::IMediaCue Cue() const noexcept;
};
...
struct consume_Windows_Media_Core_IMediaSource2
{
    ...
    Windows::Foundation::Collections::IObservableVector<Windows::Media::Core::TimedTextSource> ExternalTimedTextSources() const noexcept;
    Windows::Foundation::Collections::IObservableVector<Windows::Media::Core::TimedMetadataTrack> ExternalTimedMetadataTracks() const noexcept;
};
...
struct consume_Windows_Media_Core_IMediaSource3
{
    ...
    Windows::Media::Core::MediaSourceState State() const noexcept;
    void Reset() const;
};
...
{
    Windows::Media::Streaming::Adaptive::AdaptiveMediaSource AdaptiveMediaSource() const noexcept;
    Windows::Media::Core::MediaStreamSource MediaStreamSource() const noexcept;
    Windows::Media::Core::MseStreamSource MseStreamSource() const noexcept;
...
{
    Windows::Media::Core::MediaSourceError Error() const noexcept;
};
...
{
    Windows::Media::Core::MediaSourceState OldState() const noexcept;
    Windows::Media::Core::MediaSourceState NewState() const noexcept;
};
...
struct consume_Windows_Media_Core_IMediaStreamSample
{
    ...
    Windows::Media::Core::MediaStreamSamplePropertySet ExtendedProperties() const noexcept;
    Windows::Media::Core::MediaStreamSampleProtectionProperties Protection() const noexcept;
    void DecodeTimestamp(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan DecodeTimestamp() const noexcept;
    void Duration(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan Duration() const noexcept;
    void KeyFrame(bool value) const noexcept;
    bool KeyFrame() const noexcept;
    void Discontinuous(bool value) const noexcept;
...
struct consume_Windows_Media_Core_IMediaStreamSource
{
    ...
    void MediaProtectionManager(Windows::Media::Protection::MediaProtectionManager const& value) const noexcept;
    Windows::Media::Protection::MediaProtectionManager MediaProtectionManager() const noexcept;
    void Duration(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan Duration() const noexcept;
    void CanSeek(bool value) const noexcept;
    bool CanSeek() const noexcept;
    void BufferTime(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan BufferTime() const noexcept;
...
{
    void MaxSupportedPlaybackRate(optional<double> const& value) const noexcept;
    Windows::Foundation::IReference<double> MaxSupportedPlaybackRate() const noexcept;
};
...
{
    void IsLive(bool value) const noexcept;
...
{
    Windows::Media::Core::MediaStreamSourceClosedRequest Request() const noexcept;
};
...
{
    Windows::Media::Core::MediaStreamSourceClosedReason Reason() const noexcept;
};
...
{
    Windows::Foundation::TimeSpan SampleLag() const noexcept;
};
...
{
    Windows::Media::Core::IMediaStreamDescriptor StreamDescriptor() const noexcept;
    Windows::Media::Core::MediaStreamSourceSampleRequestDeferral GetDeferral() const;
    void Sample(Windows::Media::Core::MediaStreamSample const& value) const noexcept;
    Windows::Media::Core::MediaStreamSample Sample() const noexcept;
...
{
    Windows::Media::Core::MediaStreamSourceSampleRequest Request() const noexcept;
};
...
{
    Windows::Media::Core::MediaStreamSourceStartingRequest Request() const noexcept;
};
...
{
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> StartPosition() const noexcept;
...
{
    Windows::Media::Core::IMediaStreamDescriptor OldStreamDescriptor() const noexcept;
    Windows::Media::Core::IMediaStreamDescriptor NewStreamDescriptor() const noexcept;
...
{
    Windows::Media::Core::MediaStreamSourceSwitchStreamsRequest Request() const noexcept;
};
...
struct consume_Windows_Media_Core_IMediaTrack
{
    hstring Id() const noexcept;
    hstring Language() const noexcept;
    Windows::Media::Core::MediaTrackKind TrackKind() const noexcept;
    void Label(param::hstring const& value) const noexcept;
    hstring Label() const noexcept;
};
...
struct consume_Windows_Media_Core_IMseSourceBuffer
{
    ...
    Windows::Media::Core::MseAppendMode Mode() const noexcept;
    void Mode(Windows::Media::Core::MseAppendMode const& value) const noexcept;
    bool IsUpdating() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Core::MseTimeRange> Buffered() const noexcept;
    Windows::Foundation::TimeSpan TimestampOffset() const noexcept;
    void TimestampOffset(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan AppendWindowStart() const noexcept;
    void AppendWindowStart(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> AppendWindowEnd() const noexcept;
    void AppendWindowEnd(optional<Windows::Foundation::TimeSpan> const& value) const noexcept;
...
struct consume_Windows_Media_Core_IMseSourceBufferList
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Media::Core::MseSourceBuffer> Buffers() const noexcept;
};
...
struct consume_Windows_Media_Core_IMseStreamSource
{
    ...
    void Closed(event_token const& token) const;
    Windows::Media::Core::MseSourceBufferList SourceBuffers() const noexcept;
    Windows::Media::Core::MseSourceBufferList ActiveSourceBuffers() const noexcept;
    Windows::Media::Core::MseReadyState ReadyState() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> Duration() const noexcept;
...
{
    Windows::Foundation::IReference<Windows::Media::Core::MseTimeRange> LiveSeekableRange() const noexcept;
    void LiveSeekableRange(optional<Windows::Media::Core::MseTimeRange> const& value) const noexcept;
};
...
{
    Windows::Media::Core::HighDynamicRangeControl HighDynamicRangeAnalyzer() const noexcept;
    void DesiredAnalysisInterval(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan DesiredAnalysisInterval() const noexcept;
...
{
    Windows::Media::Capture::CapturedFrameControlValues FrameControlValues() const noexcept;
    Windows::Media::Core::HighDynamicRangeOutput HighDynamicRange() const noexcept;
};
...
{
    Windows::Media::Core::SceneAnalysisRecommendation AnalysisRecommendation() const noexcept;
};
...
{
    Windows::Media::Core::SceneAnalysisEffectFrame ResultFrame() const noexcept;
};
...
struct consume_Windows_Media_Core_ISpeechCue
{
    ...
    Windows::Foundation::IReference<int32_t> StartPositionInInput() const noexcept;
    void StartPositionInInput(optional<int32_t> const& value) const noexcept;
    Windows::Foundation::IReference<int32_t> EndPositionInInput() const noexcept;
    void EndPositionInInput(optional<int32_t> const& value) const noexcept;
};
...
struct consume_Windows_Media_Core_ITimedMetadataTrack
{
    ...
    Windows::Foundation::Collections::IVectorView<Windows::Media::Core::IMediaCue> Cues() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Core::IMediaCue> ActiveCues() const noexcept;
    Windows::Media::Core::TimedMetadataKind TimedMetadataKind() const noexcept;
    hstring DispatchType() const noexcept;
...
{
    Windows::Media::Core::TimedMetadataTrackErrorCode ErrorCode() const noexcept;
    HRESULT ExtendedError() const noexcept;
};
...
{
    Windows::Media::Core::TimedMetadataTrackError Error() const noexcept;
};
...
{
    Windows::Foundation::Collections::IVectorView<Windows::Media::Core::TimedMetadataTrack> TimedMetadataTracks() const noexcept;
};
...
{
    Windows::Media::Core::TimedTextRegion CueRegion() const noexcept;
    void CueRegion(Windows::Media::Core::TimedTextRegion const& value) const noexcept;
    Windows::Media::Core::TimedTextStyle CueStyle() const noexcept;
    void CueStyle(Windows::Media::Core::TimedTextStyle const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Media::Core::TimedTextLine> Lines() const noexcept;
};
...
struct consume_Windows_Media_Core_ITimedTextLine
{
    hstring Text() const noexcept;
    void Text(param::hstring const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::Media::Core::TimedTextSubformat> Subformats() const noexcept;
};
...
struct consume_Windows_Media_Core_ITimedTextRegion
{
    ...
    void Background(Windows::UI::Color const& value) const noexcept;
    Windows::Media::Core::TimedTextWritingMode WritingMode() const noexcept;
    void WritingMode(Windows::Media::Core::TimedTextWritingMode const& value) const noexcept;
    Windows::Media::Core::TimedTextDisplayAlignment DisplayAlignment() const noexcept;
    void DisplayAlignment(Windows::Media::Core::TimedTextDisplayAlignment const& value) const noexcept;
    Windows::Media::Core::TimedTextDouble LineHeight() const noexcept;
    void LineHeight(Windows::Media::Core::TimedTextDouble const& value) const noexcept;
    bool IsOverflowClipped() const noexcept;
    void IsOverflowClipped(bool value) const noexcept;
    Windows::Media::Core::TimedTextPadding Padding() const noexcept;
    void Padding(Windows::Media::Core::TimedTextPadding const& value) const noexcept;
    Windows::Media::Core::TimedTextWrapping TextWrapping() const noexcept;
    void TextWrapping(Windows::Media::Core::TimedTextWrapping const& value) const noexcept;
    int32_t ZIndex() const noexcept;
    void ZIndex(int32_t value) const noexcept;
    Windows::Media::Core::TimedTextScrollMode ScrollMode() const noexcept;
    void ScrollMode(Windows::Media::Core::TimedTextScrollMode const& value) const noexcept;
};
...
{
    Windows::Media::Core::TimedMetadataTrackError Error() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Core::TimedMetadataTrack> Tracks() const noexcept;
};
...
struct consume_Windows_Media_Core_ITimedTextStyle
{
    ...
    void FontFamily(param::hstring const& value) const noexcept;
    Windows::Media::Core::TimedTextDouble FontSize() const noexcept;
    void FontSize(Windows::Media::Core::TimedTextDouble const& value) const noexcept;
    Windows::Media::Core::TimedTextWeight FontWeight() const noexcept;
    void FontWeight(Windows::Media::Core::TimedTextWeight const& value) const noexcept;
    Windows::UI::Color Foreground() const noexcept;
    void Foreground(Windows::UI::Color const& value) const noexcept;
    Windows::UI::Color Background() const noexcept;
    void Background(Windows::UI::Color const& value) const noexcept;
    bool IsBackgroundAlwaysShown() const noexcept;
    void IsBackgroundAlwaysShown(bool value) const noexcept;
    Windows::Media::Core::TimedTextFlowDirection FlowDirection() const noexcept;
    void FlowDirection(Windows::Media::Core::TimedTextFlowDirection const& value) const noexcept;
    Windows::Media::Core::TimedTextLineAlignment LineAlignment() const noexcept;
    void LineAlignment(Windows::Media::Core::TimedTextLineAlignment const& value) const noexcept;
    Windows::UI::Color OutlineColor() const noexcept;
    void OutlineColor(Windows::UI::Color const& value) const noexcept;
    Windows::Media::Core::TimedTextDouble OutlineThickness() const noexcept;
    void OutlineThickness(Windows::Media::Core::TimedTextDouble const& value) const noexcept;
    Windows::Media::Core::TimedTextDouble OutlineRadius() const noexcept;
    void OutlineRadius(Windows::Media::Core::TimedTextDouble const& value) const noexcept;
};
...
{
    Windows::Media::Core::TimedTextFontStyle FontStyle() const noexcept;
    void FontStyle(Windows::Media::Core::TimedTextFontStyle const& value) const noexcept;
    bool IsUnderlineEnabled() const noexcept;
    void IsUnderlineEnabled(bool value) const noexcept;
    bool IsLineThroughEnabled() const noexcept;
    void IsLineThroughEnabled(bool value) const noexcept;
    bool IsOverlineEnabled() const noexcept;
    void IsOverlineEnabled(bool value) const noexcept;
};
...
{
    int32_t StartIndex() const noexcept;
    void StartIndex(int32_t value) const noexcept;
    int32_t Length() const noexcept;
    void Length(int32_t value) const noexcept;
    Windows::Media::Core::TimedTextStyle SubformatStyle() const noexcept;
    void SubformatStyle(Windows::Media::Core::TimedTextStyle const& value) const noexcept;
};
...
{
    Windows::Media::Core::VideoStabilizationEffectEnabledChangedReason Reason() const noexcept;
};
...
{
    Windows::Media::MediaProperties::VideoEncodingProperties EncodingProperties() const noexcept;
};
...
struct consume_Windows_Media_Core_IVideoTrack
{
    ...
    Windows::Media::Playback::MediaPlaybackItem PlaybackItem() const noexcept;
    hstring Name() const noexcept;
    Windows::Media::Core::VideoTrackSupportInfo SupportInfo() const noexcept;
};
...
{
    virtual HRESULT __stdcall add_OpenFailed(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_DecoderStatus(Windows::Media::Core::MediaDecoderStatus* value) = 0;
    virtual HRESULT __stdcall get_Degradation(Windows::Media::Core::AudioDecoderDegradation* value) = 0;
    virtual HRESULT __stdcall get_DegradationReason(Windows::Media::Core::AudioDecoderDegradationReason* value) = 0;
    virtual HRESULT __stdcall get_MediaSourceStatus(Windows::Media::Core::MediaSourceStatus* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Kind(Windows::Media::Core::CodecKind* value) = 0;
    virtual HRESULT __stdcall get_Category(Windows::Media::Core::CodecCategory* value) = 0;
...
{
    virtual HRESULT __stdcall FindAllAsync(Windows::Media::Core::CodecKind kind, Windows::Media::Core::CodecCategory category, HSTRING subType, ::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::Media::Core::IFaceDetectionEffect>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_FaceDetected(::IUnknown* handler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall put_DetectionMode(Windows::Media::Core::FaceDetectionMode value) = 0;
    virtual HRESULT __stdcall get_DetectionMode(Windows::Media::Core::FaceDetectionMode* value) = 0;
...
template <> struct abi<Windows::Media::Core::IImageCue>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Extent(struct_of<24>* value) = 0;
    virtual HRESULT __stdcall put_Extent(struct_of<24> value) = 0;
...
template <> struct abi<Windows::Media::Core::IInitializeMediaStreamSourceRequestedEventArgs>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_RandomAccessStream(::IUnknown** value) = 0;
...
{
    virtual HRESULT __stdcall get_SupportedBitmapPixelFormats(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_MaxSupportedFrameCount(int32_t* value) = 0;
    virtual HRESULT __stdcall FuseAsync(::IUnknown* frameSet, ::IUnknown** result) = 0;
};};

template <> struct abi<Windows::Media::Core::IMediaBinder>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_Binding(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_OpenOperationCompleted(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Core::IMediaSource3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_State(Windows::Media::Core::MediaSourceState* value) = 0;
...
{
    virtual HRESULT __stdcall add_InitializeMediaStreamSourceRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_InitializeMediaStreamSourceRequested(event_token token) = 0;
...
{
    virtual HRESULT __stdcall Create(::IUnknown* appServiceConnection, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall get_OldState(Windows::Media::Core::MediaSourceState* value) = 0;
    virtual HRESULT __stdcall get_NewState(Windows::Media::Core::MediaSourceState* value) = 0;
};};
...
{
    virtual HRESULT __stdcall CreateFromMediaFrameSource(::IUnknown* frameSource, ::IUnknown** result) = 0;
};};
...
{
    virtual HRESULT __stdcall add_Processed(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall CreateFromBuffer(::IUnknown* buffer, Windows::Foundation::TimeSpan timestamp, ::IUnknown** value) = 0;
    virtual HRESULT __stdcall CreateFromStreamAsync(::IUnknown* stream, uint32_t count, Windows::Foundation::TimeSpan timestamp, ::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::Media::Core::IMediaStreamSource>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Paused(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Paused(event_token token) = 0;
    virtual HRESULT __stdcall add_SampleRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SampleRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_SwitchStreamsRequested(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SwitchStreamsRequested(event_token token) = 0;
    virtual HRESULT __stdcall NotifyError(Windows::Media::Core::MediaStreamSourceErrorStatus errorStatus) = 0;
    ...
    virtual HRESULT __stdcall SetBufferedRange(Windows::Foundation::TimeSpan startOffset, Windows::Foundation::TimeSpan endOffset) = 0;
...
{
    virtual HRESULT __stdcall add_SampleRendered(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall put_IsLive(bool value) = 0;
...
{
    virtual HRESULT __stdcall get_Reason(Windows::Media::Core::MediaStreamSourceClosedReason* value) = 0;
};};
...
template <> struct abi<Windows::Media::Core::IMediaStreamSourceStartingRequest>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetDeferral(::IUnknown** deferral) = 0;
    virtual HRESULT __stdcall SetActualStartPosition(Windows::Foundation::TimeSpan position) = 0;
};};
...
template <> struct abi<Windows::Media::Core::IMediaTrack>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_Id(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_Language(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_TrackKind(Windows::Media::Core::MediaTrackKind* value) = 0;
    virtual HRESULT __stdcall put_Label(HSTRING value) = 0;
    virtual HRESULT __stdcall get_Label(HSTRING* value) = 0;
};};
...
{
    virtual HRESULT __stdcall add_UpdateStarting(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_UpdateEnded(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_Aborted(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Aborted(event_token token) = 0;
    virtual HRESULT __stdcall get_Mode(Windows::Media::Core::MseAppendMode* value) = 0;
    virtual HRESULT __stdcall put_Mode(Windows::Media::Core::MseAppendMode value) = 0;
    ...
    virtual HRESULT __stdcall Remove(Windows::Foundation::TimeSpan start, ::IUnknown* end) = 0;
};};

template <> struct abi<Windows::Media::Core::IMseSourceBufferList>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_SourceBufferAdded(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SourceBufferAdded(event_token token) = 0;
    virtual HRESULT __stdcall add_SourceBufferRemoved(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_Opened(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Opened(event_token token) = 0;
    virtual HRESULT __stdcall add_Ended(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall get_ReadyState(Windows::Media::Core::MseReadyState* value) = 0;
    virtual HRESULT __stdcall get_Duration(::IUnknown** value) = 0;
    ...
    virtual HRESULT __stdcall EndOfStream(Windows::Media::Core::MseEndOfStreamStatus status) = 0;
};};

template <> struct abi<Windows::Media::Core::IMseStreamSource2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_LiveSeekableRange(::IUnknown** value) = 0;
    virtual HRESULT __stdcall put_LiveSeekableRange(::IUnknown* value) = 0;
};};
...
template <> struct abi<Windows::Media::Core::ISceneAnalysisEffect>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_SceneAnalyzed(::IUnknown* handler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall get_AnalysisRecommendation(Windows::Media::Core::SceneAnalysisRecommendation* value) = 0;
};};
...
{
    virtual HRESULT __stdcall add_SelectedIndexChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_CueEntered(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CueEntered(event_token token) = 0;
    virtual HRESULT __stdcall add_CueExited(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CueExited(event_token token) = 0;
    virtual HRESULT __stdcall add_TrackFailed(::IUnknown* handler, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall get_TimedMetadataKind(Windows::Media::Core::TimedMetadataKind* value) = 0;
...
{
    virtual HRESULT __stdcall get_ErrorCode(Windows::Media::Core::TimedMetadataTrackErrorCode* value) = 0;
    virtual HRESULT __stdcall get_ExtendedError(HRESULT* value) = 0;
};};

template <> struct abi<Windows::Media::Core::ITimedMetadataTrackFactory>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall Create(HSTRING id, HSTRING language, Windows::Media::Core::TimedMetadataKind kind, ::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::Media::Core::ITimedTextRegion>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Extent(struct_of<24>* value) = 0;
    virtual HRESULT __stdcall put_Extent(struct_of<24> value) = 0;
    virtual HRESULT __stdcall get_Background(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall put_Background(struct_of<4> value) = 0;
    virtual HRESULT __stdcall get_WritingMode(Windows::Media::Core::TimedTextWritingMode* value) = 0;
    virtual HRESULT __stdcall put_WritingMode(Windows::Media::Core::TimedTextWritingMode value) = 0;
    virtual HRESULT __stdcall get_DisplayAlignment(Windows::Media::Core::TimedTextDisplayAlignment* value) = 0;
    virtual HRESULT __stdcall put_DisplayAlignment(Windows::Media::Core::TimedTextDisplayAlignment value) = 0;
    virtual HRESULT __stdcall get_LineHeight(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall put_LineHeight(struct_of<16> value) = 0;
    virtual HRESULT __stdcall get_IsOverflowClipped(bool* value) = 0;
    virtual HRESULT __stdcall put_IsOverflowClipped(bool value) = 0;
    virtual HRESULT __stdcall get_Padding(struct_of<40>* value) = 0;
    virtual HRESULT __stdcall put_Padding(struct_of<40> value) = 0;
    virtual HRESULT __stdcall get_TextWrapping(Windows::Media::Core::TimedTextWrapping* value) = 0;
    virtual HRESULT __stdcall put_TextWrapping(Windows::Media::Core::TimedTextWrapping value) = 0;
    virtual HRESULT __stdcall get_ZIndex(int32_t* value) = 0;
    virtual HRESULT __stdcall put_ZIndex(int32_t value) = 0;
    virtual HRESULT __stdcall get_ScrollMode(Windows::Media::Core::TimedTextScrollMode* value) = 0;
    virtual HRESULT __stdcall put_ScrollMode(Windows::Media::Core::TimedTextScrollMode value) = 0;
};};

template <> struct abi<Windows::Media::Core::ITimedTextSource>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_Resolved(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Core::ITimedTextStyle>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_FontSize(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall put_FontSize(struct_of<16> value) = 0;
    virtual HRESULT __stdcall get_FontWeight(Windows::Media::Core::TimedTextWeight* value) = 0;
    virtual HRESULT __stdcall put_FontWeight(Windows::Media::Core::TimedTextWeight value) = 0;
    virtual HRESULT __stdcall get_Foreground(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall put_Foreground(struct_of<4> value) = 0;
    virtual HRESULT __stdcall get_Background(struct_of<4>* value) = 0;
    virtual HRESULT __stdcall put_Background(struct_of<4> value) = 0;
    ...
    virtual HRESULT __stdcall get_FlowDirection(Windows::Media::Core::TimedTextFlowDirection* value) = 0;
    virtual HRESULT __stdcall put_FlowDirection(Windows::Media::Core::TimedTextFlowDirection value) = 0;
    virtual HRESULT __stdcall get_LineAlignment(Windows::Media::Core::TimedTextLineAlignment* value) = 0;
    virtual HRESULT __stdcall put_LineAlignment(Windows::Media::Core::TimedTextLineAlignment value) = 0;
    ...
    virtual HRESULT __stdcall get_OutlineThickness(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall put_OutlineThickness(struct_of<16> value) = 0;
    virtual HRESULT __stdcall get_OutlineRadius(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall put_OutlineRadius(struct_of<16> value) = 0;
};};

template <> struct abi<Windows::Media::Core::ITimedTextStyle2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_FontStyle(Windows::Media::Core::TimedTextFontStyle* value) = 0;
    virtual HRESULT __stdcall put_FontStyle(Windows::Media::Core::TimedTextFontStyle value) = 0;
...
template <> struct abi<Windows::Media::Core::IVideoStabilizationEffect>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall put_Enabled(bool value) = 0;
    virtual HRESULT __stdcall get_Enabled(bool* value) = 0;
    virtual HRESULT __stdcall add_EnabledChanged(::IUnknown* handler, event_token* cookie) = 0;
...
{
    virtual HRESULT __stdcall get_Reason(Windows::Media::Core::VideoStabilizationEffectEnabledChangedReason* value) = 0;
};};
