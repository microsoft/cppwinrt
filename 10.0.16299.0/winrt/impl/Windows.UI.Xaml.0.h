...
{
    double MinWindowWidth() const noexcept;
    void MinWindowWidth(double value) const noexcept;
    double MinWindowHeight() const noexcept;
    void MinWindowHeight(double value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty MinWindowWidthProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MinWindowHeightProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::ResourceDictionary Resources() const noexcept;
    void Resources(Windows::UI::Xaml::ResourceDictionary const& value) const noexcept;
    Windows::UI::Xaml::DebugSettings DebugSettings() const noexcept;
    Windows::UI::Xaml::ApplicationTheme RequestedTheme() const noexcept;
    void RequestedTheme(Windows::UI::Xaml::ApplicationTheme const& value) const noexcept;
...
{
    Windows::UI::Xaml::FocusVisualKind FocusVisualKind() const noexcept;
    void FocusVisualKind(Windows::UI::Xaml::FocusVisualKind const& value) const noexcept;
    Windows::UI::Xaml::ApplicationRequiresPointerMode RequiresPointerMode() const noexcept;
    void RequiresPointerMode(Windows::UI::Xaml::ApplicationRequiresPointerMode const& value) const noexcept;
...
{
    Windows::UI::Xaml::ApplicationHighContrastAdjustment HighContrastAdjustment() const noexcept;
    void HighContrastAdjustment(Windows::UI::Xaml::ApplicationHighContrastAdjustment const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::Application Current() const noexcept;
...
{
    bool AnimationDesired() const noexcept;
    void AnimationDesired(bool value) const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::Rect> TargetRect() const noexcept;
    void TargetRect(optional<Windows::Foundation::Rect> const& value) const noexcept;
};
...
{
    Windows::Foundation::IInspectable NewValue() const noexcept;
...
{
    Windows::Foundation::IInspectable DataType() const noexcept;
    void DataType(Windows::Foundation::IInspectable const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty ExtensionInstanceProperty() const noexcept;
...
{
    bool EnableFrameRateCounter() const noexcept;
    void EnableFrameRateCounter(bool value) const noexcept;
    bool IsBindingTracingEnabled() const noexcept;
    void IsBindingTracingEnabled(bool value) const noexcept;
    bool IsOverdrawHeatMapEnabled() const noexcept;
    void IsOverdrawHeatMapEnabled(bool value) const noexcept;
...
{
    bool EnableRedrawRegions() const noexcept;
    void EnableRedrawRegions(bool value) const noexcept;
};
...
{
    bool IsTextPerformanceVisualizationEnabled() const noexcept;
    void IsTextPerformanceVisualizationEnabled(bool value) const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty Property() const noexcept;
    Windows::Foundation::IInspectable OldValue() const noexcept;
    Windows::Foundation::IInspectable NewValue() const noexcept;
};
...
{
    Windows::Foundation::IInspectable UnsetValue() const noexcept;
...
{
    Windows::ApplicationModel::DataTransfer::DataPackageView DataView() const noexcept;
    Windows::UI::Xaml::DragUIOverride DragUIOverride() const noexcept;
    Windows::ApplicationModel::DataTransfer::DragDrop::DragDropModifiers Modifiers() const noexcept;
    Windows::ApplicationModel::DataTransfer::DataPackageOperation AcceptedOperation() const noexcept;
    void AcceptedOperation(Windows::ApplicationModel::DataTransfer::DataPackageOperation const& value) const noexcept;
...
struct consume_Windows_UI_Xaml_IDragStartingEventArgs
{
    ...
    Windows::ApplicationModel::DataTransfer::DataPackage Data() const noexcept;
    Windows::UI::Xaml::DragUI DragUI() const noexcept;
    Windows::UI::Xaml::DragOperationDeferral GetDeferral() const;
    Windows::Foundation::Point GetPosition(Windows::UI::Xaml::UIElement const& relativeTo) const;
};
...
{
    Windows::ApplicationModel::DataTransfer::DataPackageOperation DropResult() const noexcept;
};
...
{
    Windows::UI::Xaml::Duration Automatic() const noexcept;
    Windows::UI::Xaml::Duration Forever() const noexcept;
...
struct consume_Windows_UI_Xaml_IElementSoundPlayerStatics
{
    ...
    Windows::UI::Xaml::ElementSoundPlayerState State() const noexcept;
    void State(Windows::UI::Xaml::ElementSoundPlayerState const& value) const noexcept;
...
{
    Windows::UI::Xaml::RoutedEvent RoutedEvent() const noexcept;
    void RoutedEvent(Windows::UI::Xaml::RoutedEvent const& value) const noexcept;
    Windows::UI::Xaml::TriggerActionCollection Actions() const noexcept;
};
...
{
    Windows::UI::Xaml::TriggerCollection Triggers() const noexcept;
    Windows::UI::Xaml::ResourceDictionary Resources() const noexcept;
    void Resources(Windows::UI::Xaml::ResourceDictionary const& value) const noexcept;
    ...
    void Height(double value) const noexcept;
    double MinWidth() const noexcept;
    void MinWidth(double value) const noexcept;
    double MaxWidth() const noexcept;
    void MaxWidth(double value) const noexcept;
    double MinHeight() const noexcept;
    void MinHeight(double value) const noexcept;
    double MaxHeight() const noexcept;
    void MaxHeight(double value) const noexcept;
    Windows::UI::Xaml::HorizontalAlignment HorizontalAlignment() const noexcept;
    void HorizontalAlignment(Windows::UI::Xaml::HorizontalAlignment const& value) const noexcept;
    Windows::UI::Xaml::VerticalAlignment VerticalAlignment() const noexcept;
    void VerticalAlignment(Windows::UI::Xaml::VerticalAlignment const& value) const noexcept;
    ...
    Windows::Foundation::IInspectable DataContext() const noexcept;
    void DataContext(Windows::Foundation::IInspectable const& value) const noexcept;
    Windows::UI::Xaml::Style Style() const noexcept;
    void Style(Windows::UI::Xaml::Style const& value) const noexcept;
...
{
    Windows::UI::Xaml::ElementTheme RequestedTheme() const noexcept;
    void RequestedTheme(Windows::UI::Xaml::ElementTheme const& value) const noexcept;
...
struct consume_Windows_UI_Xaml_IFrameworkElement4
{
    ...
    Windows::UI::Xaml::Thickness FocusVisualMargin() const noexcept;
    void FocusVisualMargin(Windows::UI::Xaml::Thickness const& value) const noexcept;
    Windows::UI::Xaml::Thickness FocusVisualSecondaryThickness() const noexcept;
    void FocusVisualSecondaryThickness(Windows::UI::Xaml::Thickness const& value) const noexcept;
    Windows::UI::Xaml::Thickness FocusVisualPrimaryThickness() const noexcept;
    void FocusVisualPrimaryThickness(Windows::UI::Xaml::Thickness const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush FocusVisualSecondaryBrush() const noexcept;
    void FocusVisualSecondaryBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
    Windows::UI::Xaml::Media::Brush FocusVisualPrimaryBrush() const noexcept;
    void FocusVisualPrimaryBrush(Windows::UI::Xaml::Media::Brush const& value) const noexcept;
...
{
    Windows::UI::Xaml::ElementTheme ActualTheme() const noexcept;
...
struct consume_Windows_UI_Xaml_IFrameworkElementStatics
{
    ...
    Windows::UI::Xaml::DependencyProperty ActualWidthProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ActualHeightProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty WidthProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty HeightProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MinWidthProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MaxWidthProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MinHeightProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty MaxHeightProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty HorizontalAlignmentProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty VerticalAlignmentProperty() const noexcept;
    ...
    Windows::UI::Xaml::DependencyProperty DataContextProperty() const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty RequestedThemeProperty() const noexcept;
};
...
struct consume_Windows_UI_Xaml_IFrameworkElementStatics4
{
    ...
    Windows::UI::Xaml::DependencyProperty FocusVisualMarginProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty FocusVisualSecondaryThicknessProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty FocusVisualPrimaryThicknessProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty FocusVisualSecondaryBrushProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty FocusVisualPrimaryBrushProperty() const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty ActualThemeProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::GridLength Auto() const noexcept;
...
{
    hstring ErrorTrace() const noexcept;
};
...
{
    Windows::Foundation::IInspectable DefaultValue() const noexcept;
    Windows::UI::Xaml::CreateDefaultValueCallback CreateDefaultValueCallback() const noexcept;
};
...
{
    Windows::Foundation::Rect Empty() const noexcept;
...
{
    Windows::Foundation::Uri Source() const noexcept;
    void Source(Windows::Foundation::Uri const& value) const noexcept;
    Windows::Foundation::Collections::IVector<Windows::UI::Xaml::ResourceDictionary> MergedDictionaries() const noexcept;
    Windows::Foundation::Collections::IMap<Windows::Foundation::IInspectable, Windows::Foundation::IInspectable> ThemeDictionaries() const noexcept;
};
...
{
    Windows::Foundation::IInspectable OriginalSource() const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty Property() const noexcept;
    void Property(Windows::UI::Xaml::DependencyProperty const& value) const noexcept;
...
{
    Windows::UI::Xaml::TargetPropertyPath Target() const noexcept;
    void Target(Windows::UI::Xaml::TargetPropertyPath const& value) const noexcept;
};
...
{
    Windows::Foundation::Size PreviousSize() const noexcept;
    Windows::Foundation::Size NewSize() const noexcept;
};
...
{
    Windows::Foundation::Size Empty() const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty IsActiveProperty() const noexcept;
};
...
{
    bool IsSealed() const noexcept;
    Windows::UI::Xaml::SetterBaseCollection Setters() const noexcept;
    Windows::UI::Xaml::Interop::TypeName TargetType() const noexcept;
    void TargetType(Windows::UI::Xaml::Interop::TypeName const& value) const noexcept;
    Windows::UI::Xaml::Style BasedOn() const noexcept;
    void BasedOn(Windows::UI::Xaml::Style const& value) const noexcept;
    void Seal() const;
};
...
struct consume_Windows_UI_Xaml_ITargetPropertyPath
{
    ...
    Windows::Foundation::IInspectable Target() const noexcept;
    void Target(Windows::Foundation::IInspectable const& value) const noexcept;
};
...
{
    Windows::Foundation::Size DesiredSize() const noexcept;
    bool AllowDrop() const noexcept;
    void AllowDrop(bool value) const noexcept;
    double Opacity() const noexcept;
    void Opacity(double value) const noexcept;
    Windows::UI::Xaml::Media::RectangleGeometry Clip() const noexcept;
    void Clip(Windows::UI::Xaml::Media::RectangleGeometry const& value) const noexcept;
    Windows::UI::Xaml::Media::Transform RenderTransform() const noexcept;
    void RenderTransform(Windows::UI::Xaml::Media::Transform const& value) const noexcept;
    Windows::UI::Xaml::Media::Projection Projection() const noexcept;
    void Projection(Windows::UI::Xaml::Media::Projection const& value) const noexcept;
    Windows::Foundation::Point RenderTransformOrigin() const noexcept;
    void RenderTransformOrigin(Windows::Foundation::Point const& value) const noexcept;
    bool IsHitTestVisible() const noexcept;
    void IsHitTestVisible(bool value) const noexcept;
    Windows::UI::Xaml::Visibility Visibility() const noexcept;
    void Visibility(Windows::UI::Xaml::Visibility const& value) const noexcept;
    Windows::Foundation::Size RenderSize() const noexcept;
    bool UseLayoutRounding() const noexcept;
    void UseLayoutRounding(bool value) const noexcept;
    Windows::UI::Xaml::Media::Animation::TransitionCollection Transitions() const noexcept;
    void Transitions(Windows::UI::Xaml::Media::Animation::TransitionCollection const& value) const noexcept;
    Windows::UI::Xaml::Media::CacheMode CacheMode() const noexcept;
    void CacheMode(Windows::UI::Xaml::Media::CacheMode const& value) const noexcept;
    bool IsTapEnabled() const noexcept;
    void IsTapEnabled(bool value) const noexcept;
    bool IsDoubleTapEnabled() const noexcept;
    void IsDoubleTapEnabled(bool value) const noexcept;
    bool IsRightTapEnabled() const noexcept;
    void IsRightTapEnabled(bool value) const noexcept;
    bool IsHoldingEnabled() const noexcept;
    void IsHoldingEnabled(bool value) const noexcept;
    Windows::UI::Xaml::Input::ManipulationModes ManipulationMode() const noexcept;
    void ManipulationMode(Windows::UI::Xaml::Input::ManipulationModes const& value) const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::UI::Xaml::Input::Pointer> PointerCaptures() const noexcept;
...
{
    Windows::UI::Xaml::Media::ElementCompositeMode CompositeMode() const noexcept;
    void CompositeMode(Windows::UI::Xaml::Media::ElementCompositeMode const& value) const noexcept;
...
{
    Windows::UI::Xaml::Media::Media3D::Transform3D Transform3D() const noexcept;
    void Transform3D(Windows::UI::Xaml::Media::Media3D::Transform3D const& value) const noexcept;
    bool CanDrag() const noexcept;
    void CanDrag(bool value) const noexcept;
...
{
    Windows::UI::Xaml::Controls::Primitives::FlyoutBase ContextFlyout() const noexcept;
    void ContextFlyout(Windows::UI::Xaml::Controls::Primitives::FlyoutBase const& value) const noexcept;
...
{
    Windows::Foundation::Collections::IVector<Windows::UI::Xaml::Media::XamlLight> Lights() const noexcept;
    ...
    Windows::UI::Xaml::Input::XYFocusKeyboardNavigationMode XYFocusKeyboardNavigation() const noexcept;
    void XYFocusKeyboardNavigation(Windows::UI::Xaml::Input::XYFocusKeyboardNavigationMode const& value) const noexcept;
    ...
    Windows::UI::Xaml::ElementHighContrastAdjustment HighContrastAdjustment() const noexcept;
    void HighContrastAdjustment(Windows::UI::Xaml::ElementHighContrastAdjustment const& value) const noexcept;
    Windows::UI::Xaml::Input::KeyboardNavigationMode TabFocusNavigation() const noexcept;
    void TabFocusNavigation(Windows::UI::Xaml::Input::KeyboardNavigationMode const& value) const noexcept;
...
{
    Windows::Foundation::Collections::IVector<Windows::UI::Xaml::Input::KeyboardAccelerator> KeyboardAccelerators() const noexcept;
...
{
    Windows::UI::Xaml::RoutedEvent KeyDownEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent KeyUpEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent PointerEnteredEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent PointerPressedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent PointerMovedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent PointerReleasedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent PointerExitedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent PointerCaptureLostEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent PointerCanceledEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent PointerWheelChangedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent TappedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent DoubleTappedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent HoldingEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent RightTappedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent ManipulationStartingEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent ManipulationInertiaStartingEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent ManipulationStartedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent ManipulationDeltaEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent ManipulationCompletedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent DragEnterEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent DragLeaveEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent DragOverEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent DropEvent() const noexcept;
    Windows::UI::Xaml::DependencyProperty AllowDropProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty OpacityProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ClipProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RenderTransformProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ProjectionProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty RenderTransformOriginProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsHitTestVisibleProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty VisibilityProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty UseLayoutRoundingProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TransitionsProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CacheModeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsTapEnabledProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsDoubleTapEnabledProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsRightTapEnabledProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty IsHoldingEnabledProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty ManipulationModeProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty PointerCapturesProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty CompositeModeProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::DependencyProperty Transform3DProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty CanDragProperty() const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty ContextFlyoutProperty() const noexcept;
...
{
    Windows::UI::Xaml::DependencyProperty LightsProperty() const noexcept;
    ...
    Windows::UI::Xaml::DependencyProperty XYFocusKeyboardNavigationProperty() const noexcept;
    ...
    Windows::UI::Xaml::DependencyProperty HighContrastAdjustmentProperty() const noexcept;
    Windows::UI::Xaml::DependencyProperty TabFocusNavigationProperty() const noexcept;
};
...
{
    Windows::UI::Xaml::RoutedEvent GettingFocusEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent LosingFocusEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent NoFocusCandidateFoundEvent() const noexcept;
};
...
{
    Windows::UI::Xaml::RoutedEvent PreviewKeyDownEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent CharacterReceivedEvent() const noexcept;
    Windows::UI::Xaml::RoutedEvent PreviewKeyUpEvent() const noexcept;
};
...
{
    hstring Name() const noexcept;
    Windows::UI::Xaml::Media::Animation::Storyboard Storyboard() const noexcept;
    void Storyboard(Windows::UI::Xaml::Media::Animation::Storyboard const& value) const noexcept;
};
...
{
    Windows::UI::Xaml::SetterBaseCollection Setters() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::UI::Xaml::StateTriggerBase> StateTriggers() const noexcept;
};
...
{
    Windows::UI::Xaml::VisualState OldState() const noexcept;
    void OldState(Windows::UI::Xaml::VisualState const& value) const noexcept;
    Windows::UI::Xaml::VisualState NewState() const noexcept;
    void NewState(Windows::UI::Xaml::VisualState const& value) const noexcept;
    Windows::UI::Xaml::Controls::Control Control() const noexcept;
    void Control(Windows::UI::Xaml::Controls::Control const& value) const noexcept;
};
...
{
    hstring Name() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::UI::Xaml::VisualTransition> Transitions() const noexcept;
    Windows::Foundation::Collections::IVector<Windows::UI::Xaml::VisualState> States() const noexcept;
    Windows::UI::Xaml::VisualState CurrentState() const noexcept;
...
struct consume_Windows_UI_Xaml_IVisualStateManagerStatics
{
    ...
    Windows::UI::Xaml::DependencyProperty CustomVisualStateManagerProperty() const noexcept;
...
{
    Windows::UI::Xaml::Duration GeneratedDuration() const noexcept;
    void GeneratedDuration(Windows::UI::Xaml::Duration const& value) const noexcept;
    Windows::UI::Xaml::Media::Animation::EasingFunctionBase GeneratedEasingFunction() const noexcept;
    void GeneratedEasingFunction(Windows::UI::Xaml::Media::Animation::EasingFunctionBase const& value) const noexcept;
...
struct consume_Windows_UI_Xaml_IWindow
{
    ...
    Windows::UI::Xaml::UIElement Content() const noexcept;
    void Content(Windows::UI::Xaml::UIElement const& value) const noexcept;
...
{
    Windows::UI::Xaml::Window Window() const noexcept;
};
...
{
    Windows::UI::Xaml::Window Current() const noexcept;
};
...
template <> struct abi<Windows::UI::Xaml::IApplication>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_RequestedTheme(Windows::UI::Xaml::ApplicationTheme* value) = 0;
    virtual HRESULT __stdcall put_RequestedTheme(Windows::UI::Xaml::ApplicationTheme value) = 0;
    virtual HRESULT __stdcall add_UnhandledException(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_UnhandledException(event_token token) = 0;
    virtual HRESULT __stdcall add_Suspending(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Suspending(event_token token) = 0;
    virtual HRESULT __stdcall add_Resuming(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_FocusVisualKind(Windows::UI::Xaml::FocusVisualKind* value) = 0;
    virtual HRESULT __stdcall put_FocusVisualKind(Windows::UI::Xaml::FocusVisualKind value) = 0;
    virtual HRESULT __stdcall get_RequiresPointerMode(Windows::UI::Xaml::ApplicationRequiresPointerMode* value) = 0;
    virtual HRESULT __stdcall put_RequiresPointerMode(Windows::UI::Xaml::ApplicationRequiresPointerMode value) = 0;
    virtual HRESULT __stdcall add_LeavingBackground(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_LeavingBackground(event_token token) = 0;
    virtual HRESULT __stdcall add_EnteredBackground(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_HighContrastAdjustment(Windows::UI::Xaml::ApplicationHighContrastAdjustment* value) = 0;
    virtual HRESULT __stdcall put_HighContrastAdjustment(Windows::UI::Xaml::ApplicationHighContrastAdjustment value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IApplicationStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall LoadComponentWithResourceLocation(::IUnknown* component, ::IUnknown* resourceLocator, Windows::UI::Xaml::Controls::Primitives::ComponentResourceLocation componentResourceLocation) = 0;
};};
...
{
    virtual HRESULT __stdcall FromRadii(double topLeft, double topRight, double bottomRight, double bottomLeft, struct_of<32>* returnValue) = 0;
    virtual HRESULT __stdcall FromUniformRadius(double uniformRadius, struct_of<32>* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IDebugSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_BindingFailed(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall GetMetadata(struct_of<8,16> forType, ::IUnknown** returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IDependencyPropertyStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall Register(HSTRING name, struct_of<8,16> propertyType, struct_of<8,16> ownerType, ::IUnknown* typeMetadata, ::IUnknown** returnValue) = 0;
    virtual HRESULT __stdcall RegisterAttached(HSTRING name, struct_of<8,16> propertyType, struct_of<8,16> ownerType, ::IUnknown* defaultMetadata, ::IUnknown** returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IDispatcherTimer>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_Tick(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Xaml::IDragEventArgs2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AcceptedOperation(Windows::ApplicationModel::DataTransfer::DataPackageOperation* value) = 0;
    virtual HRESULT __stdcall put_AcceptedOperation(Windows::ApplicationModel::DataTransfer::DataPackageOperation value) = 0;
...
template <> struct abi<Windows::UI::Xaml::IDragUI>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SetContentFromBitmapImageWithAnchorPoint(::IUnknown* bitmapImage, Windows::Foundation::Point anchorPoint) = 0;
...
{
    virtual HRESULT __stdcall get_DropResult(Windows::ApplicationModel::DataTransfer::DataPackageOperation* value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Automatic(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall get_Forever(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall Compare(struct_of<16> duration1, struct_of<16> duration2, int32_t* returnValue) = 0;
    virtual HRESULT __stdcall FromTimeSpan(Windows::Foundation::TimeSpan timeSpan, struct_of<16>* returnValue) = 0;
    virtual HRESULT __stdcall GetHasTimeSpan(struct_of<16> target, bool* value) = 0;
    virtual HRESULT __stdcall Add(struct_of<16> target, struct_of<16> duration, struct_of<16>* returnValue) = 0;
    virtual HRESULT __stdcall Equals(struct_of<16> target, struct_of<16> value, bool* returnValue) = 0;
    virtual HRESULT __stdcall Subtract(struct_of<16> target, struct_of<16> duration, struct_of<16>* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IElementSoundPlayerStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_State(Windows::UI::Xaml::ElementSoundPlayerState* value) = 0;
    virtual HRESULT __stdcall put_State(Windows::UI::Xaml::ElementSoundPlayerState value) = 0;
    virtual HRESULT __stdcall Play(Windows::UI::Xaml::ElementSoundKind sound) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IFrameworkElement>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_HorizontalAlignment(Windows::UI::Xaml::HorizontalAlignment* value) = 0;
    virtual HRESULT __stdcall put_HorizontalAlignment(Windows::UI::Xaml::HorizontalAlignment value) = 0;
    virtual HRESULT __stdcall get_VerticalAlignment(Windows::UI::Xaml::VerticalAlignment* value) = 0;
    virtual HRESULT __stdcall put_VerticalAlignment(Windows::UI::Xaml::VerticalAlignment value) = 0;
    ...
    virtual HRESULT __stdcall add_Loaded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Loaded(event_token token) = 0;
    virtual HRESULT __stdcall add_Unloaded(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Unloaded(event_token token) = 0;
    virtual HRESULT __stdcall add_SizeChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SizeChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_LayoutUpdated(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_RequestedTheme(Windows::UI::Xaml::ElementTheme* value) = 0;
    virtual HRESULT __stdcall put_RequestedTheme(Windows::UI::Xaml::ElementTheme value) = 0;
    virtual HRESULT __stdcall add_DataContextChanged(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_Loading(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Xaml::IFrameworkElement4>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_FocusVisualMargin(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_FocusVisualMargin(struct_of<32> value) = 0;
    virtual HRESULT __stdcall get_FocusVisualSecondaryThickness(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_FocusVisualSecondaryThickness(struct_of<32> value) = 0;
    virtual HRESULT __stdcall get_FocusVisualPrimaryThickness(struct_of<32>* value) = 0;
    virtual HRESULT __stdcall put_FocusVisualPrimaryThickness(struct_of<32> value) = 0;
...
{
    virtual HRESULT __stdcall get_ActualTheme(Windows::UI::Xaml::ElementTheme* value) = 0;
    virtual HRESULT __stdcall add_ActualThemeChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ActualThemeChanged(event_token token) = 0;
};};
...
{
    virtual HRESULT __stdcall MeasureOverride(Windows::Foundation::Size availableSize, Windows::Foundation::Size* returnValue) = 0;
    virtual HRESULT __stdcall ArrangeOverride(Windows::Foundation::Size finalSize, Windows::Foundation::Size* returnValue) = 0;
...
{
    virtual HRESULT __stdcall get_ActualThemeProperty(::IUnknown** value) = 0;
};};
...
{
    virtual HRESULT __stdcall get_Auto(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall FromPixels(double pixels, struct_of<16>* returnValue) = 0;
    virtual HRESULT __stdcall FromValueAndType(double value, Windows::UI::Xaml::GridUnitType type, struct_of<16>* returnValue) = 0;
    virtual HRESULT __stdcall GetIsAbsolute(struct_of<16> target, bool* value) = 0;
    virtual HRESULT __stdcall GetIsAuto(struct_of<16> target, bool* value) = 0;
    virtual HRESULT __stdcall GetIsStar(struct_of<16> target, bool* value) = 0;
    virtual HRESULT __stdcall Equals(struct_of<16> target, struct_of<16> value, bool* returnValue) = 0;
};};
...
{
    virtual HRESULT __stdcall FromCoordinates(float x, float y, Windows::Foundation::Point* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IRectHelperStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall FromCoordinatesAndDimensions(float x, float y, float width, float height, Windows::Foundation::Rect* returnValue) = 0;
    virtual HRESULT __stdcall FromPoints(Windows::Foundation::Point point1, Windows::Foundation::Point point2, Windows::Foundation::Rect* returnValue) = 0;
    virtual HRESULT __stdcall FromLocationAndSize(Windows::Foundation::Point location, Windows::Foundation::Size size, Windows::Foundation::Rect* returnValue) = 0;
    virtual HRESULT __stdcall GetIsEmpty(Windows::Foundation::Rect target, bool* value) = 0;
    virtual HRESULT __stdcall GetBottom(Windows::Foundation::Rect target, float* value) = 0;
    virtual HRESULT __stdcall GetLeft(Windows::Foundation::Rect target, float* value) = 0;
    virtual HRESULT __stdcall GetRight(Windows::Foundation::Rect target, float* value) = 0;
    virtual HRESULT __stdcall GetTop(Windows::Foundation::Rect target, float* value) = 0;
    virtual HRESULT __stdcall Contains(Windows::Foundation::Rect target, Windows::Foundation::Point point, bool* returnValue) = 0;
    virtual HRESULT __stdcall Equals(Windows::Foundation::Rect target, Windows::Foundation::Rect value, bool* returnValue) = 0;
    virtual HRESULT __stdcall Intersect(Windows::Foundation::Rect target, Windows::Foundation::Rect rect, Windows::Foundation::Rect* returnValue) = 0;
    virtual HRESULT __stdcall UnionWithPoint(Windows::Foundation::Rect target, Windows::Foundation::Point point, Windows::Foundation::Rect* returnValue) = 0;
    virtual HRESULT __stdcall UnionWithRect(Windows::Foundation::Rect target, Windows::Foundation::Rect rect, Windows::Foundation::Rect* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::ISizeHelperStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall FromDimensions(float width, float height, Windows::Foundation::Size* returnValue) = 0;
    virtual HRESULT __stdcall GetIsEmpty(Windows::Foundation::Size target, bool* value) = 0;
    virtual HRESULT __stdcall Equals(Windows::Foundation::Size target, Windows::Foundation::Size value, bool* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IStyle>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_TargetType(struct_of<8,16>* value) = 0;
    virtual HRESULT __stdcall put_TargetType(struct_of<8,16> value) = 0;
...
{
    virtual HRESULT __stdcall CreateInstance(struct_of<8,16> targetType, ::IUnknown** instance) = 0;
};};
...
{
    virtual HRESULT __stdcall FromLengths(double left, double top, double right, double bottom, struct_of<32>* returnValue) = 0;
    virtual HRESULT __stdcall FromUniformLength(double uniformLength, struct_of<32>* returnValue) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IUIElement>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Visibility(Windows::UI::Xaml::Visibility* value) = 0;
    virtual HRESULT __stdcall put_Visibility(Windows::UI::Xaml::Visibility value) = 0;
    ...
    virtual HRESULT __stdcall get_ManipulationMode(Windows::UI::Xaml::Input::ManipulationModes* value) = 0;
    virtual HRESULT __stdcall put_ManipulationMode(Windows::UI::Xaml::Input::ManipulationModes value) = 0;
    virtual HRESULT __stdcall get_PointerCaptures(::IUnknown** value) = 0;
    virtual HRESULT __stdcall add_KeyUp(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_KeyUp(event_token token) = 0;
    virtual HRESULT __stdcall add_KeyDown(::IUnknown* value, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_DragEnter(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DragEnter(event_token token) = 0;
    virtual HRESULT __stdcall add_DragLeave(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DragLeave(event_token token) = 0;
    virtual HRESULT __stdcall add_DragOver(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DragOver(event_token token) = 0;
    virtual HRESULT __stdcall add_Drop(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Drop(event_token token) = 0;
    virtual HRESULT __stdcall add_PointerPressed(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PointerPressed(event_token token) = 0;
    virtual HRESULT __stdcall add_PointerMoved(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PointerMoved(event_token token) = 0;
    virtual HRESULT __stdcall add_PointerReleased(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PointerReleased(event_token token) = 0;
    virtual HRESULT __stdcall add_PointerEntered(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PointerEntered(event_token token) = 0;
    virtual HRESULT __stdcall add_PointerExited(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PointerExited(event_token token) = 0;
    virtual HRESULT __stdcall add_PointerCaptureLost(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PointerCaptureLost(event_token token) = 0;
    virtual HRESULT __stdcall add_PointerCanceled(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PointerCanceled(event_token token) = 0;
    virtual HRESULT __stdcall add_PointerWheelChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PointerWheelChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_Tapped(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Tapped(event_token token) = 0;
    virtual HRESULT __stdcall add_DoubleTapped(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DoubleTapped(event_token token) = 0;
    virtual HRESULT __stdcall add_Holding(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_Holding(event_token token) = 0;
    virtual HRESULT __stdcall add_RightTapped(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_RightTapped(event_token token) = 0;
    virtual HRESULT __stdcall add_ManipulationStarting(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ManipulationStarting(event_token token) = 0;
    virtual HRESULT __stdcall add_ManipulationInertiaStarting(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ManipulationInertiaStarting(event_token token) = 0;
    virtual HRESULT __stdcall add_ManipulationStarted(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ManipulationStarted(event_token token) = 0;
    virtual HRESULT __stdcall add_ManipulationDelta(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ManipulationDelta(event_token token) = 0;
    virtual HRESULT __stdcall add_ManipulationCompleted(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ManipulationCompleted(event_token token) = 0;
    virtual HRESULT __stdcall Measure(Windows::Foundation::Size availableSize) = 0;
    virtual HRESULT __stdcall Arrange(Windows::Foundation::Rect finalRect) = 0;
...
{
    virtual HRESULT __stdcall get_CompositeMode(Windows::UI::Xaml::Media::ElementCompositeMode* value) = 0;
    virtual HRESULT __stdcall put_CompositeMode(Windows::UI::Xaml::Media::ElementCompositeMode value) = 0;
...
template <> struct abi<Windows::UI::Xaml::IUIElement3>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_DragStarting(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DragStarting(event_token token) = 0;
    virtual HRESULT __stdcall add_DropCompleted(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Xaml::IUIElement4>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_ContextRequested(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ContextRequested(event_token token) = 0;
    virtual HRESULT __stdcall add_ContextCanceled(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::UI::Xaml::IUIElement5>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_XYFocusKeyboardNavigation(Windows::UI::Xaml::Input::XYFocusKeyboardNavigationMode* value) = 0;
    virtual HRESULT __stdcall put_XYFocusKeyboardNavigation(Windows::UI::Xaml::Input::XYFocusKeyboardNavigationMode value) = 0;
    ...
    virtual HRESULT __stdcall get_HighContrastAdjustment(Windows::UI::Xaml::ElementHighContrastAdjustment* value) = 0;
    virtual HRESULT __stdcall put_HighContrastAdjustment(Windows::UI::Xaml::ElementHighContrastAdjustment value) = 0;
    virtual HRESULT __stdcall get_TabFocusNavigation(Windows::UI::Xaml::Input::KeyboardNavigationMode* value) = 0;
    virtual HRESULT __stdcall put_TabFocusNavigation(Windows::UI::Xaml::Input::KeyboardNavigationMode value) = 0;
    virtual HRESULT __stdcall add_GettingFocus(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_GettingFocus(event_token token) = 0;
    virtual HRESULT __stdcall add_LosingFocus(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_LosingFocus(event_token token) = 0;
    virtual HRESULT __stdcall add_NoFocusCandidateFound(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_KeyboardAccelerators(::IUnknown** value) = 0;
    virtual HRESULT __stdcall add_CharacterReceived(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CharacterReceived(event_token token) = 0;
    virtual HRESULT __stdcall add_ProcessKeyboardAccelerators(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ProcessKeyboardAccelerators(event_token token) = 0;
    virtual HRESULT __stdcall add_PreviewKeyDown(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PreviewKeyDown(event_token token) = 0;
    virtual HRESULT __stdcall add_PreviewKeyUp(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PreviewKeyUp(event_token token) = 0;
...
template <> struct abi<Windows::UI::Xaml::IUIElementOverrides>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall FindSubElementsForTouchTargeting(Windows::Foundation::Point point, Windows::Foundation::Rect boundingRect, ::IUnknown** returnValue) = 0;
};};

template <> struct abi<Windows::UI::Xaml::IUIElementOverrides7>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall GetChildrenInTabFocusOrder(::IUnknown** returnValue) = 0;
...
{
    virtual HRESULT __stdcall get_PreviewKeyDownEvent(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_CharacterReceivedEvent(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_PreviewKeyUpEvent(::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::UI::Xaml::IVisualStateGroup>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_CurrentStateChanging(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_GeneratedDuration(struct_of<16>* value) = 0;
    virtual HRESULT __stdcall put_GeneratedDuration(struct_of<16> value) = 0;
...
template <> struct abi<Windows::UI::Xaml::IWindow>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Dispatcher(::IUnknown** value) = 0;
    virtual HRESULT __stdcall add_Activated(::IUnknown* value, event_token* token) = 0;
    ...
    virtual HRESULT __stdcall add_SizeChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_SizeChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_VisibilityChanged(::IUnknown* value, event_token* token) = 0;
