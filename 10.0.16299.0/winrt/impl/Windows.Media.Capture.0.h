...
struct consume_Windows_Media_Capture_IAdvancedCapturedPhoto
{
    ...
    Windows::Foundation::IInspectable Context() const noexcept;
};
...
{
    Windows::Foundation::IReference<Windows::Foundation::Rect> FrameBoundsRelativeToReferencePhoto() const noexcept;
};
...
{
    void PlugInState(Windows::Media::Capture::AppBroadcastPlugInState const& value) const noexcept;
    Windows::Media::Capture::AppBroadcastPlugInState PlugInState() const noexcept;
    void SignInInfo(Windows::Media::Capture::AppBroadcastBackgroundServiceSignInInfo const& value) const noexcept;
    Windows::Media::Capture::AppBroadcastBackgroundServiceSignInInfo SignInInfo() const noexcept;
    void StreamInfo(Windows::Media::Capture::AppBroadcastBackgroundServiceStreamInfo const& value) const noexcept;
    Windows::Media::Capture::AppBroadcastBackgroundServiceStreamInfo StreamInfo() const noexcept;
    hstring AppId() const noexcept;
    hstring BroadcastTitle() const noexcept;
    void ViewerCount(uint32_t value) const noexcept;
    uint32_t ViewerCount() const noexcept;
...
{
    void BroadcastTitle(param::hstring const& value) const noexcept;
    hstring BroadcastLanguage() const noexcept;
    void BroadcastLanguage(param::hstring const& value) const noexcept;
    hstring BroadcastChannel() const noexcept;
    void BroadcastChannel(param::hstring const& value) const noexcept;
...
{
    Windows::Media::Capture::AppBroadcastSignInState SignInState() const noexcept;
    void OAuthRequestUri(Windows::Foundation::Uri const& value) const noexcept;
    Windows::Foundation::Uri OAuthRequestUri() const noexcept;
    void OAuthCallbackUri(Windows::Foundation::Uri const& value) const noexcept;
    Windows::Foundation::Uri OAuthCallbackUri() const noexcept;
    Windows::Security::Authentication::Web::WebAuthenticationResult AuthenticationResult() const noexcept;
...
{
    Windows::Media::Capture::AppBroadcastStreamState StreamState() const noexcept;
    void DesiredVideoEncodingBitrate(uint64_t value) const noexcept;
    uint64_t DesiredVideoEncodingBitrate() const noexcept;
    void BandwidthTestBitrate(uint64_t value) const noexcept;
    uint64_t BandwidthTestBitrate() const noexcept;
    void AudioCodec(param::hstring const& value) const noexcept;
    hstring AudioCodec() const noexcept;
    Windows::Media::Capture::AppBroadcastStreamReader BroadcastStreamReader() const noexcept;
...
{
    Windows::Media::Capture::AppBroadcastCameraCaptureState State() const noexcept;
...
{
    bool IsBroadcastEnabled() const noexcept;
    bool IsDisabledByPolicy() const noexcept;
    bool IsGpuConstrained() const noexcept;
    bool HasHardwareEncoder() const noexcept;
    void IsAudioCaptureEnabled(bool value) const noexcept;
    bool IsAudioCaptureEnabled() const noexcept;
    void IsMicrophoneCaptureEnabledByDefault(bool value) const noexcept;
    bool IsMicrophoneCaptureEnabledByDefault() const noexcept;
    void IsEchoCancellationEnabled(bool value) const noexcept;
    bool IsEchoCancellationEnabled() const noexcept;
    void SystemAudioGain(double value) const noexcept;
    double SystemAudioGain() const noexcept;
    void MicrophoneGain(double value) const noexcept;
    double MicrophoneGain() const noexcept;
    void IsCameraCaptureEnabledByDefault(bool value) const noexcept;
    bool IsCameraCaptureEnabledByDefault() const noexcept;
    void SelectedCameraId(param::hstring const& value) const noexcept;
    hstring SelectedCameraId() const noexcept;
    void CameraOverlayLocation(Windows::Media::Capture::AppBroadcastCameraOverlayLocation const& value) const noexcept;
    Windows::Media::Capture::AppBroadcastCameraOverlayLocation CameraOverlayLocation() const noexcept;
    void CameraOverlaySize(Windows::Media::Capture::AppBroadcastCameraOverlaySize const& value) const noexcept;
    Windows::Media::Capture::AppBroadcastCameraOverlaySize CameraOverlaySize() const noexcept;
    void IsCursorImageCaptureEnabled(bool value) const noexcept;
    bool IsCursorImageCaptureEnabled() const noexcept;
};
...
{
    Windows::Media::Capture::AppBroadcastMicrophoneCaptureState State() const noexcept;
    uint32_t ErrorCode() const noexcept;
};
...
{
    hstring AppId() const noexcept;
    Windows::Media::Capture::AppBroadcastProviderSettings ProviderSettings() const noexcept;
    Windows::Storage::Streams::IRandomAccessStreamReference Logo() const noexcept;
...
{
    bool IsBroadcastProviderAvailable() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Capture::AppBroadcastPlugIn> PlugInList() const noexcept;
    Windows::Media::Capture::AppBroadcastPlugIn DefaultPlugIn() const noexcept;
    void DefaultPlugIn(Windows::Media::Capture::AppBroadcastPlugIn const& value) const noexcept;
};
...
struct consume_Windows_Media_Capture_IAppBroadcastPreview
{
    ...
    Windows::Media::Capture::AppBroadcastPreviewState PreviewState() const noexcept;
    Windows::Foundation::IReference<uint32_t> ErrorCode() const noexcept;
    ...
    Windows::Media::Capture::AppBroadcastPreviewStreamReader PreviewStreamReader() const noexcept;
};
...
{
    uint32_t VideoWidth() const noexcept;
    uint32_t VideoHeight() const noexcept;
    uint32_t VideoStride() const noexcept;
    Windows::Graphics::Imaging::BitmapPixelFormat VideoBitmapPixelFormat() const noexcept;
    Windows::Graphics::Imaging::BitmapAlphaMode VideoBitmapAlphaMode() const noexcept;
...
{
    Windows::Media::Capture::AppBroadcastPreviewStreamVideoHeader VideoHeader() const noexcept;
    Windows::Storage::Streams::IBuffer VideoBuffer() const noexcept;
};
...
{
    Windows::Foundation::DateTime AbsoluteTimestamp() const noexcept;
    Windows::Foundation::TimeSpan RelativeTimestamp() const noexcept;
...
{
    void DefaultBroadcastTitle(param::hstring const& value) const noexcept;
    hstring DefaultBroadcastTitle() const noexcept;
    void AudioEncodingBitrate(uint32_t value) const noexcept;
    uint32_t AudioEncodingBitrate() const noexcept;
    void CustomVideoEncodingBitrate(uint32_t value) const noexcept;
    uint32_t CustomVideoEncodingBitrate() const noexcept;
    void CustomVideoEncodingHeight(uint32_t value) const noexcept;
    uint32_t CustomVideoEncodingHeight() const noexcept;
    void CustomVideoEncodingWidth(uint32_t value) const noexcept;
    uint32_t CustomVideoEncodingWidth() const noexcept;
    void VideoEncodingBitrateMode(Windows::Media::Capture::AppBroadcastVideoEncodingBitrateMode const& value) const noexcept;
    Windows::Media::Capture::AppBroadcastVideoEncodingBitrateMode VideoEncodingBitrateMode() const noexcept;
    void VideoEncodingResolutionMode(Windows::Media::Capture::AppBroadcastVideoEncodingResolutionMode const& value) const noexcept;
    Windows::Media::Capture::AppBroadcastVideoEncodingResolutionMode VideoEncodingResolutionMode() const noexcept;
};
...
{
    Windows::Media::Capture::AppBroadcastCaptureTargetType CaptureTargetType() const noexcept;
    void CaptureTargetType(Windows::Media::Capture::AppBroadcastCaptureTargetType const& value) const noexcept;
    hstring BroadcastTitle() const noexcept;
    void BroadcastTitle(param::hstring const& value) const noexcept;
    hstring BroadcastLanguage() const noexcept;
    void BroadcastLanguage(param::hstring const& value) const noexcept;
    hstring UserName() const noexcept;
    bool CanCapture() const noexcept;
    ...
    Windows::Media::Capture::AppBroadcastState State() const noexcept;
};
...
{
    Windows::Media::Capture::AppBroadcastSignInState SignInState() const noexcept;
    Windows::Media::Capture::AppBroadcastSignInResult Result() const noexcept;
};
...
{
    bool IsCaptureTargetRunning() const noexcept;
    uint32_t ViewerCount() const noexcept;
    bool ShouldCaptureMicrophone() const noexcept;
    void ShouldCaptureMicrophone(bool value) const noexcept;
    void RestartMicrophoneCapture() const;
    bool ShouldCaptureCamera() const noexcept;
    void ShouldCaptureCamera(bool value) const noexcept;
    void RestartCameraCapture() const;
    Windows::Foundation::Size EncodedVideoSize() const noexcept;
    Windows::Media::Capture::AppBroadcastMicrophoneCaptureState MicrophoneCaptureState() const noexcept;
    uint32_t MicrophoneCaptureError() const noexcept;
    Windows::Media::Capture::AppBroadcastCameraCaptureState CameraCaptureState() const noexcept;
    uint32_t CameraCaptureError() const noexcept;
    Windows::Media::Capture::AppBroadcastStreamState StreamState() const noexcept;
    Windows::Media::Capture::AppBroadcastPlugInState PlugInState() const noexcept;
    Windows::Foundation::Uri OAuthRequestUri() const noexcept;
    Windows::Foundation::Uri OAuthCallbackUri() const noexcept;
    Windows::Security::Authentication::Web::WebAuthenticationResult AuthenticationResult() const noexcept;
    void AuthenticationResult(Windows::Security::Authentication::Web::WebAuthenticationResult const& value) const noexcept;
    void SignInState(Windows::Media::Capture::AppBroadcastSignInState const& value) const noexcept;
    Windows::Media::Capture::AppBroadcastSignInState SignInState() const noexcept;
    Windows::Media::Capture::AppBroadcastTerminationReason TerminationReason() const noexcept;
    uint32_t TerminationReasonPlugInSpecific() const noexcept;
...
{
    Windows::Media::Capture::AppBroadcastStreamAudioHeader AudioHeader() const noexcept;
    Windows::Storage::Streams::IBuffer AudioBuffer() const noexcept;
};
...
{
    uint32_t AudioChannels() const noexcept;
    uint32_t AudioSampleRate() const noexcept;
    Windows::Storage::Streams::IBuffer AudioAacSequence() const noexcept;
    uint32_t AudioBitrate() const noexcept;
    Windows::Media::Capture::AppBroadcastStreamAudioFrame TryGetNextAudioFrame() const;
    uint32_t VideoWidth() const noexcept;
    uint32_t VideoHeight() const noexcept;
    uint32_t VideoBitrate() const noexcept;
...
{
    Windows::Media::Capture::AppBroadcastStreamVideoHeader VideoHeader() const noexcept;
    Windows::Storage::Streams::IBuffer VideoBuffer() const noexcept;
};
...
{
    Windows::Media::Capture::AppBroadcastBackgroundService BackgroundService() const noexcept;
};
...
{
    bool IsCapturingAudio() const noexcept;
    bool IsCapturingVideo() const noexcept;
...
{
    void ToggleGameBarKey(Windows::System::VirtualKey const& value) const noexcept;
    Windows::System::VirtualKey ToggleGameBarKey() const noexcept;
    void ToggleGameBarKeyModifiers(Windows::System::VirtualKeyModifiers const& value) const noexcept;
    Windows::System::VirtualKeyModifiers ToggleGameBarKeyModifiers() const noexcept;
    void SaveHistoricalVideoKey(Windows::System::VirtualKey const& value) const noexcept;
    Windows::System::VirtualKey SaveHistoricalVideoKey() const noexcept;
    void SaveHistoricalVideoKeyModifiers(Windows::System::VirtualKeyModifiers const& value) const noexcept;
    Windows::System::VirtualKeyModifiers SaveHistoricalVideoKeyModifiers() const noexcept;
    void ToggleRecordingKey(Windows::System::VirtualKey const& value) const noexcept;
    Windows::System::VirtualKey ToggleRecordingKey() const noexcept;
    void ToggleRecordingKeyModifiers(Windows::System::VirtualKeyModifiers const& value) const noexcept;
    Windows::System::VirtualKeyModifiers ToggleRecordingKeyModifiers() const noexcept;
    void TakeScreenshotKey(Windows::System::VirtualKey const& value) const noexcept;
    Windows::System::VirtualKey TakeScreenshotKey() const noexcept;
    void TakeScreenshotKeyModifiers(Windows::System::VirtualKeyModifiers const& value) const noexcept;
    Windows::System::VirtualKeyModifiers TakeScreenshotKeyModifiers() const noexcept;
    void ToggleRecordingIndicatorKey(Windows::System::VirtualKey const& value) const noexcept;
    Windows::System::VirtualKey ToggleRecordingIndicatorKey() const noexcept;
    void ToggleRecordingIndicatorKeyModifiers(Windows::System::VirtualKeyModifiers const& value) const noexcept;
    Windows::System::VirtualKeyModifiers ToggleRecordingIndicatorKeyModifiers() const noexcept;
};
...
{
    void ToggleMicrophoneCaptureKey(Windows::System::VirtualKey const& value) const noexcept;
    Windows::System::VirtualKey ToggleMicrophoneCaptureKey() const noexcept;
    void ToggleMicrophoneCaptureKeyModifiers(Windows::System::VirtualKeyModifiers const& value) const noexcept;
    Windows::System::VirtualKeyModifiers ToggleMicrophoneCaptureKeyModifiers() const noexcept;
};
...
{
    void ToggleCameraCaptureKey(Windows::System::VirtualKey const& value) const noexcept;
    Windows::System::VirtualKey ToggleCameraCaptureKey() const noexcept;
    void ToggleCameraCaptureKeyModifiers(Windows::System::VirtualKeyModifiers const& value) const noexcept;
    Windows::System::VirtualKeyModifiers ToggleCameraCaptureKeyModifiers() const noexcept;
    void ToggleBroadcastKey(Windows::System::VirtualKey const& value) const noexcept;
    Windows::System::VirtualKey ToggleBroadcastKey() const noexcept;
    void ToggleBroadcastKeyModifiers(Windows::System::VirtualKeyModifiers const& value) const noexcept;
    Windows::System::VirtualKeyModifiers ToggleBroadcastKeyModifiers() const noexcept;
};
...
struct consume_Windows_Media_Capture_IAppCaptureMetadataWriter
{
    ...
    uint64_t RemainingStorageBytesAvailable() const noexcept;
...
{
    Windows::Media::Capture::AppCaptureMicrophoneCaptureState State() const noexcept;
    uint32_t ErrorCode() const noexcept;
};
...
struct consume_Windows_Media_Capture_IAppCaptureRecordOperation
{
    ...
    Windows::Media::Capture::AppCaptureRecordingState State() const noexcept;
    Windows::Foundation::IReference<uint32_t> ErrorCode() const noexcept;
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> Duration() const noexcept;
    Windows::Storage::StorageFile File() const noexcept;
    Windows::Foundation::IReference<bool> IsFileTruncated() const noexcept;
...
struct consume_Windows_Media_Capture_IAppCaptureServices
{
    ...
    bool CanCapture() const noexcept;
    Windows::Media::Capture::AppCaptureState State() const noexcept;
};
...
{
    void AppCaptureDestinationFolder(Windows::Storage::StorageFolder const& value) const noexcept;
    Windows::Storage::StorageFolder AppCaptureDestinationFolder() const noexcept;
    void AudioEncodingBitrate(uint32_t value) const noexcept;
    uint32_t AudioEncodingBitrate() const noexcept;
    void IsAudioCaptureEnabled(bool value) const noexcept;
    bool IsAudioCaptureEnabled() const noexcept;
    ...
    void CustomVideoEncodingWidth(uint32_t value) const noexcept;
    uint32_t CustomVideoEncodingWidth() const noexcept;
    void HistoricalBufferLength(uint32_t value) const noexcept;
    uint32_t HistoricalBufferLength() const noexcept;
    void HistoricalBufferLengthUnit(Windows::Media::Capture::AppCaptureHistoricalBufferLengthUnit const& value) const noexcept;
    Windows::Media::Capture::AppCaptureHistoricalBufferLengthUnit HistoricalBufferLengthUnit() const noexcept;
    void IsHistoricalCaptureEnabled(bool value) const noexcept;
    bool IsHistoricalCaptureEnabled() const noexcept;
    void IsHistoricalCaptureOnBatteryAllowed(bool value) const noexcept;
    bool IsHistoricalCaptureOnBatteryAllowed() const noexcept;
    void IsHistoricalCaptureOnWirelessDisplayAllowed(bool value) const noexcept;
    bool IsHistoricalCaptureOnWirelessDisplayAllowed() const noexcept;
    void MaximumRecordLength(Windows::Foundation::TimeSpan const& value) const noexcept;
    Windows::Foundation::TimeSpan MaximumRecordLength() const noexcept;
    void ScreenshotDestinationFolder(Windows::Storage::StorageFolder const& value) const noexcept;
    Windows::Storage::StorageFolder ScreenshotDestinationFolder() const noexcept;
    void VideoEncodingBitrateMode(Windows::Media::Capture::AppCaptureVideoEncodingBitrateMode const& value) const noexcept;
    Windows::Media::Capture::AppCaptureVideoEncodingBitrateMode VideoEncodingBitrateMode() const noexcept;
    void VideoEncodingResolutionMode(Windows::Media::Capture::AppCaptureVideoEncodingResolutionMode const& value) const noexcept;
    Windows::Media::Capture::AppCaptureVideoEncodingResolutionMode VideoEncodingResolutionMode() const noexcept;
    void IsAppCaptureEnabled(bool value) const noexcept;
    bool IsAppCaptureEnabled() const noexcept;
    bool IsCpuConstrained() const noexcept;
    bool IsDisabledByPolicy() const noexcept;
    bool IsMemoryConstrained() const noexcept;
    bool HasHardwareEncoder() const noexcept;
};
...
{
    bool IsGpuConstrained() const noexcept;
    Windows::Media::Capture::AppCaptureAlternateShortcutKeys AlternateShortcutKeys() const noexcept;
};
...
{
    void IsMicrophoneCaptureEnabled(bool value) const noexcept;
    bool IsMicrophoneCaptureEnabled() const noexcept;
};
...
struct consume_Windows_Media_Capture_IAppCaptureSettings4
{
    ...
    void MicrophoneGain(double value) const noexcept;
    double MicrophoneGain() const noexcept;
    void VideoEncodingFrameRateMode(Windows::Media::Capture::AppCaptureVideoEncodingFrameRateMode const& value) const noexcept;
    Windows::Media::Capture::AppCaptureVideoEncodingFrameRateMode VideoEncodingFrameRateMode() const noexcept;
};
...
{
    bool IsTargetRunning() const noexcept;
    bool IsHistoricalCaptureEnabled() const noexcept;
    bool ShouldCaptureMicrophone() const noexcept;
    void ShouldCaptureMicrophone(bool value) const noexcept;
    void RestartMicrophoneCapture() const;
    Windows::Media::Capture::AppCaptureMicrophoneCaptureState MicrophoneCaptureState() const noexcept;
    uint32_t MicrophoneCaptureError() const noexcept;
...
{
    Windows::Media::Capture::CameraCaptureUIPhotoCaptureSettings PhotoSettings() const noexcept;
    Windows::Media::Capture::CameraCaptureUIVideoCaptureSettings VideoSettings() const noexcept;
...
{
    Windows::Media::Capture::CameraCaptureUIPhotoFormat Format() const noexcept;
    void Format(Windows::Media::Capture::CameraCaptureUIPhotoFormat const& value) const noexcept;
    Windows::Media::Capture::CameraCaptureUIMaxPhotoResolution MaxResolution() const noexcept;
    void MaxResolution(Windows::Media::Capture::CameraCaptureUIMaxPhotoResolution const& value) const noexcept;
    Windows::Foundation::Size CroppedSizeInPixels() const noexcept;
    void CroppedSizeInPixels(Windows::Foundation::Size const& value) const noexcept;
    Windows::Foundation::Size CroppedAspectRatio() const noexcept;
    void CroppedAspectRatio(Windows::Foundation::Size const& value) const noexcept;
    bool AllowCropping() const noexcept;
    void AllowCropping(bool value) const noexcept;
};
...
{
    Windows::Media::Capture::CameraCaptureUIVideoFormat Format() const noexcept;
    void Format(Windows::Media::Capture::CameraCaptureUIVideoFormat const& value) const noexcept;
    Windows::Media::Capture::CameraCaptureUIMaxVideoResolution MaxResolution() const noexcept;
    void MaxResolution(Windows::Media::Capture::CameraCaptureUIMaxVideoResolution const& value) const noexcept;
    float MaxDurationInSeconds() const noexcept;
    void MaxDurationInSeconds(float value) const noexcept;
    bool AllowTrimming() const noexcept;
    void AllowTrimming(bool value) const noexcept;
};
...
{
    Windows::Foundation::IReference<Windows::Foundation::TimeSpan> Exposure() const noexcept;
    Windows::Foundation::IReference<float> ExposureCompensation() const noexcept;
    Windows::Foundation::IReference<uint32_t> IsoSpeed() const noexcept;
    Windows::Foundation::IReference<uint32_t> Focus() const noexcept;
    Windows::Foundation::IReference<Windows::Media::Devices::CaptureSceneMode> SceneMode() const noexcept;
    Windows::Foundation::IReference<bool> Flashed() const noexcept;
    Windows::Foundation::IReference<float> FlashPowerPercent() const noexcept;
    Windows::Foundation::IReference<uint32_t> WhiteBalance() const noexcept;
    Windows::Foundation::IReference<float> ZoomFactor() const noexcept;
};
...
{
    Windows::Foundation::IReference<Windows::Media::Devices::MediaCaptureFocusState> FocusState() const noexcept;
    Windows::Foundation::IReference<double> IsoDigitalGain() const noexcept;
    Windows::Foundation::IReference<double> IsoAnalogGain() const noexcept;
    Windows::Media::MediaProperties::MediaRatio SensorFrameRate() const noexcept;
    Windows::Foundation::IReference<Windows::Media::Capture::WhiteBalanceGain> WhiteBalanceGain() const noexcept;
};
...
{
    Windows::Media::Capture::CapturedFrame Frame() const noexcept;
    Windows::Media::Capture::CapturedFrame Thumbnail() const noexcept;
};
...
{
    Windows::Media::Capture::GameBarTargetCapturePolicy TargetCapturePolicy() const noexcept;
    void EnableCapture() const;
    void DisableCapture() const;
    Windows::Media::Capture::GameBarServicesTargetInfo TargetInfo() const noexcept;
    hstring SessionId() const noexcept;
    Windows::Media::Capture::AppBroadcastServices AppBroadcastServices() const noexcept;
    Windows::Media::Capture::AppCaptureServices AppCaptureServices() const noexcept;
...
{
    Windows::Media::Capture::GameBarCommand Command() const noexcept;
    Windows::Media::Capture::GameBarCommandOrigin Origin() const noexcept;
};
...
{
    Windows::Media::Capture::GameBarServices GameBarServices() const noexcept;
};
...
struct consume_Windows_Media_Capture_IGameBarServicesTargetInfo
{
    ...
    hstring AppId() const noexcept;
    hstring TitleId() const noexcept;
    Windows::Media::Capture::GameBarServicesDisplayMode DisplayMode() const noexcept;
};
...
struct consume_Windows_Media_Capture_IMediaCapture
{
    ...
    Windows::Media::Capture::MediaCaptureSettings MediaCaptureSettings() const noexcept;
    Windows::Media::Devices::AudioDeviceController AudioDeviceController() const noexcept;
...
struct consume_Windows_Media_Capture_IMediaCapture4
{
    ...
    Windows::Media::Devices::CameraStreamState CameraStreamState() const noexcept;
    ...
    Windows::Media::Capture::MediaCaptureThermalStatus ThermalStatus() const noexcept;
...
struct consume_Windows_Media_Capture_IMediaCapture5
{
    ...
    Windows::Foundation::Collections::IMapView<hstring, Windows::Media::Capture::Frames::MediaFrameSource> FrameSources() const noexcept;
...
struct consume_Windows_Media_Capture_IMediaCaptureDeviceExclusiveControlStatusChangedEventArgs
{
    ...
    Windows::Media::Capture::MediaCaptureDeviceExclusiveControlStatus Status() const noexcept;
};
...
{
    void AudioDeviceId(param::hstring const& value) const noexcept;
    hstring AudioDeviceId() const noexcept;
    void VideoDeviceId(param::hstring const& value) const noexcept;
    hstring VideoDeviceId() const noexcept;
    void StreamingCaptureMode(Windows::Media::Capture::StreamingCaptureMode const& value) const noexcept;
    Windows::Media::Capture::StreamingCaptureMode StreamingCaptureMode() const noexcept;
    void PhotoCaptureSource(Windows::Media::Capture::PhotoCaptureSource const& value) const noexcept;
    Windows::Media::Capture::PhotoCaptureSource PhotoCaptureSource() const noexcept;
};
...
{
    void MediaCategory(Windows::Media::Capture::MediaCategory const& value) const noexcept;
    Windows::Media::Capture::MediaCategory MediaCategory() const noexcept;
    void AudioProcessing(Windows::Media::AudioProcessing const& value) const noexcept;
    Windows::Media::AudioProcessing AudioProcessing() const noexcept;
};
...
{
    void AudioSource(Windows::Media::Core::IMediaSource const& value) const noexcept;
    Windows::Media::Core::IMediaSource AudioSource() const noexcept;
    void VideoSource(Windows::Media::Core::IMediaSource const& value) const noexcept;
    Windows::Media::Core::IMediaSource VideoSource() const noexcept;
};
...
{
    Windows::Media::Capture::MediaCaptureVideoProfile VideoProfile() const noexcept;
    void VideoProfile(Windows::Media::Capture::MediaCaptureVideoProfile const& value) const noexcept;
    Windows::Media::Capture::MediaCaptureVideoProfileMediaDescription PreviewMediaDescription() const noexcept;
    void PreviewMediaDescription(Windows::Media::Capture::MediaCaptureVideoProfileMediaDescription const& value) const noexcept;
    Windows::Media::Capture::MediaCaptureVideoProfileMediaDescription RecordMediaDescription() const noexcept;
    void RecordMediaDescription(Windows::Media::Capture::MediaCaptureVideoProfileMediaDescription const& value) const noexcept;
    Windows::Media::Capture::MediaCaptureVideoProfileMediaDescription PhotoMediaDescription() const noexcept;
    void PhotoMediaDescription(Windows::Media::Capture::MediaCaptureVideoProfileMediaDescription const& value) const noexcept;
};
...
struct consume_Windows_Media_Capture_IMediaCaptureInitializationSettings5
{
    ...
    void SourceGroup(Windows::Media::Capture::Frames::MediaFrameSourceGroup const& value) const noexcept;
    Windows::Media::Capture::MediaCaptureSharingMode SharingMode() const noexcept;
    void SharingMode(Windows::Media::Capture::MediaCaptureSharingMode const& value) const noexcept;
    Windows::Media::Capture::MediaCaptureMemoryPreference MemoryPreference() const noexcept;
    void MemoryPreference(Windows::Media::Capture::MediaCaptureMemoryPreference const& value) const noexcept;
};
...
{
    bool AlwaysPlaySystemShutterSound() const noexcept;
    void AlwaysPlaySystemShutterSound(bool value) const noexcept;
};
...
{
    Windows::Media::VideoFrame LastFrame() const noexcept;
    Windows::Foundation::TimeSpan RecordDuration() const noexcept;
};
...
struct consume_Windows_Media_Capture_IMediaCaptureSettings
{
    ...
    Windows::Media::Capture::StreamingCaptureMode StreamingCaptureMode() const noexcept;
    Windows::Media::Capture::PhotoCaptureSource PhotoCaptureSource() const noexcept;
    Windows::Media::Capture::VideoDeviceCharacteristic VideoDeviceCharacteristic() const noexcept;
};
...
{
    bool ConcurrentRecordAndPhotoSupported() const noexcept;
    bool ConcurrentRecordAndPhotoSequenceSupported() const noexcept;
    bool CameraSoundRequiredForRegion() const noexcept;
    Windows::Foundation::IReference<uint32_t> Horizontal35mmEquivalentFocalLength() const noexcept;
    Windows::Foundation::IReference<int32_t> PitchOffsetDegrees() const noexcept;
    Windows::Foundation::IReference<uint32_t> Vertical35mmEquivalentFocalLength() const noexcept;
    Windows::Media::Capture::MediaCategory MediaCategory() const noexcept;
    Windows::Media::AudioProcessing AudioProcessing() const noexcept;
};
...
struct consume_Windows_Media_Capture_IMediaCaptureVideoProfile
{
    ...
    hstring VideoDeviceId() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Capture::MediaCaptureVideoProfileMediaDescription> SupportedPreviewMediaDescription() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Capture::MediaCaptureVideoProfileMediaDescription> SupportedRecordMediaDescription() const noexcept;
    Windows::Foundation::Collections::IVectorView<Windows::Media::Capture::MediaCaptureVideoProfileMediaDescription> SupportedPhotoMediaDescription() const noexcept;
...
struct consume_Windows_Media_Capture_IMediaCaptureVideoProfileMediaDescription
{
    ...
    bool IsVariablePhotoSequenceSupported() const noexcept;
    bool IsHdrVideoSupported() const noexcept;
};
...
struct consume_Windows_Media_Capture_IScreenCapture
{
    Windows::Media::Core::IMediaSource AudioSource() const noexcept;
    Windows::Media::Core::IMediaSource VideoSource() const noexcept;
    bool IsAudioSuspended() const noexcept;
    bool IsVideoSuspended() const noexcept;
...
{
    Windows::Media::MediaProperties::VideoEncodingProperties InputProperties() const noexcept;
    Windows::Media::MediaProperties::VideoEncodingProperties OutputProperties() const noexcept;
};
...
{
    virtual HRESULT __stdcall put_PlugInState(Windows::Media::Capture::AppBroadcastPlugInState value) = 0;
    virtual HRESULT __stdcall get_PlugInState(Windows::Media::Capture::AppBroadcastPlugInState* value) = 0;
    ...
    virtual HRESULT __stdcall TerminateBroadcast(Windows::Media::Capture::AppBroadcastTerminationReason reason, uint32_t providerSpecificReason) = 0;
    virtual HRESULT __stdcall add_HeartbeatRequested(::IUnknown* handler, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Capture::IAppBroadcastBackgroundService2>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_BroadcastChannel(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_BroadcastChannel(HSTRING value) = 0;
    virtual HRESULT __stdcall add_BroadcastTitleChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BroadcastTitleChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_BroadcastLanguageChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BroadcastLanguageChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_BroadcastChannelChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_BroadcastChannelChanged(event_token token) = 0;
};};

template <> struct abi<Windows::Media::Capture::IAppBroadcastBackgroundServiceSignInInfo>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_SignInState(Windows::Media::Capture::AppBroadcastSignInState* value) = 0;
    ...
    virtual HRESULT __stdcall add_SignInStateChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall add_UserNameChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_UserNameChanged(event_token token) = 0;
};};

template <> struct abi<Windows::Media::Capture::IAppBroadcastBackgroundServiceStreamInfo>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_StreamState(Windows::Media::Capture::AppBroadcastStreamState* value) = 0;
    ...
    virtual HRESULT __stdcall add_StreamStateChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_StreamStateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_VideoEncodingResolutionChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_VideoEncodingResolutionChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_VideoEncodingBitrateChanged(::IUnknown* handler, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall ReportProblemWithStream() = 0;
};};

template <> struct abi<Windows::Media::Capture::IAppBroadcastCameraCaptureStateChangedEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_State(Windows::Media::Capture::AppBroadcastCameraCaptureState* value) = 0;
...
template <> struct abi<Windows::Media::Capture::IAppBroadcastGlobalSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_CameraOverlayLocation(Windows::Media::Capture::AppBroadcastCameraOverlayLocation value) = 0;
    virtual HRESULT __stdcall get_CameraOverlayLocation(Windows::Media::Capture::AppBroadcastCameraOverlayLocation* value) = 0;
    virtual HRESULT __stdcall put_CameraOverlaySize(Windows::Media::Capture::AppBroadcastCameraOverlaySize value) = 0;
    virtual HRESULT __stdcall get_CameraOverlaySize(Windows::Media::Capture::AppBroadcastCameraOverlaySize* value) = 0;
...
{
    virtual HRESULT __stdcall get_State(Windows::Media::Capture::AppBroadcastMicrophoneCaptureState* value) = 0;
    virtual HRESULT __stdcall get_ErrorCode(uint32_t* value) = 0;
};};
...
template <> struct abi<Windows::Media::Capture::IAppBroadcastPreview>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_PreviewState(Windows::Media::Capture::AppBroadcastPreviewState* value) = 0;
    virtual HRESULT __stdcall get_ErrorCode(::IUnknown** value) = 0;
    virtual HRESULT __stdcall add_PreviewStateChanged(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Capture::IAppBroadcastPreviewStreamReader>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_VideoBitmapPixelFormat(Windows::Graphics::Imaging::BitmapPixelFormat* value) = 0;
    virtual HRESULT __stdcall get_VideoBitmapAlphaMode(Windows::Graphics::Imaging::BitmapAlphaMode* value) = 0;
    virtual HRESULT __stdcall TryGetNextVideoFrame(::IUnknown** frame) = 0;
    virtual HRESULT __stdcall add_VideoFrameArrived(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Capture::IAppBroadcastProviderSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_VideoEncodingBitrateMode(Windows::Media::Capture::AppBroadcastVideoEncodingBitrateMode value) = 0;
    virtual HRESULT __stdcall get_VideoEncodingBitrateMode(Windows::Media::Capture::AppBroadcastVideoEncodingBitrateMode* value) = 0;
    virtual HRESULT __stdcall put_VideoEncodingResolutionMode(Windows::Media::Capture::AppBroadcastVideoEncodingResolutionMode value) = 0;
    virtual HRESULT __stdcall get_VideoEncodingResolutionMode(Windows::Media::Capture::AppBroadcastVideoEncodingResolutionMode* value) = 0;
};};

template <> struct abi<Windows::Media::Capture::IAppBroadcastServices>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_CaptureTargetType(Windows::Media::Capture::AppBroadcastCaptureTargetType* value) = 0;
    virtual HRESULT __stdcall put_CaptureTargetType(Windows::Media::Capture::AppBroadcastCaptureTargetType value) = 0;
    virtual HRESULT __stdcall get_BroadcastTitle(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_BroadcastTitle(HSTRING value) = 0;
    virtual HRESULT __stdcall get_BroadcastLanguage(HSTRING* value) = 0;
    virtual HRESULT __stdcall put_BroadcastLanguage(HSTRING value) = 0;
    ...
    virtual HRESULT __stdcall ExitBroadcastMode(Windows::Media::Capture::AppBroadcastExitBroadcastModeReason reason) = 0;
    ...
    virtual HRESULT __stdcall StartPreview(Windows::Foundation::Size desiredSize, ::IUnknown** preview) = 0;
...
{
    virtual HRESULT __stdcall get_SignInState(Windows::Media::Capture::AppBroadcastSignInState* value) = 0;
    virtual HRESULT __stdcall get_Result(Windows::Media::Capture::AppBroadcastSignInResult* value) = 0;
};};
...
template <> struct abi<Windows::Media::Capture::IAppBroadcastState>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_MicrophoneCaptureState(Windows::Media::Capture::AppBroadcastMicrophoneCaptureState* value) = 0;
    virtual HRESULT __stdcall get_MicrophoneCaptureError(uint32_t* value) = 0;
    virtual HRESULT __stdcall get_CameraCaptureState(Windows::Media::Capture::AppBroadcastCameraCaptureState* value) = 0;
    ...
    virtual HRESULT __stdcall put_SignInState(Windows::Media::Capture::AppBroadcastSignInState value) = 0;
    virtual HRESULT __stdcall get_SignInState(Windows::Media::Capture::AppBroadcastSignInState* value) = 0;
    virtual HRESULT __stdcall get_TerminationReason(Windows::Media::Capture::AppBroadcastTerminationReason* value) = 0;
    virtual HRESULT __stdcall get_TerminationReasonPlugInSpecific(uint32_t* value) = 0;
    virtual HRESULT __stdcall add_ViewerCountChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_ViewerCountChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_MicrophoneCaptureStateChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MicrophoneCaptureStateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_CameraCaptureStateChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_CameraCaptureStateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_PlugInStateChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_PlugInStateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_StreamStateChanged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_StreamStateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_CaptureTargetClosed(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Capture::IAppBroadcastStreamReader>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall TryGetNextVideoFrame(::IUnknown** frame) = 0;
    virtual HRESULT __stdcall add_AudioFrameArrived(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall put_ToggleGameBarKey(Windows::System::VirtualKey value) = 0;
    virtual HRESULT __stdcall get_ToggleGameBarKey(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall put_ToggleGameBarKeyModifiers(Windows::System::VirtualKeyModifiers value) = 0;
    virtual HRESULT __stdcall get_ToggleGameBarKeyModifiers(Windows::System::VirtualKeyModifiers* value) = 0;
    virtual HRESULT __stdcall put_SaveHistoricalVideoKey(Windows::System::VirtualKey value) = 0;
    virtual HRESULT __stdcall get_SaveHistoricalVideoKey(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall put_SaveHistoricalVideoKeyModifiers(Windows::System::VirtualKeyModifiers value) = 0;
    virtual HRESULT __stdcall get_SaveHistoricalVideoKeyModifiers(Windows::System::VirtualKeyModifiers* value) = 0;
    virtual HRESULT __stdcall put_ToggleRecordingKey(Windows::System::VirtualKey value) = 0;
    virtual HRESULT __stdcall get_ToggleRecordingKey(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall put_ToggleRecordingKeyModifiers(Windows::System::VirtualKeyModifiers value) = 0;
    virtual HRESULT __stdcall get_ToggleRecordingKeyModifiers(Windows::System::VirtualKeyModifiers* value) = 0;
    virtual HRESULT __stdcall put_TakeScreenshotKey(Windows::System::VirtualKey value) = 0;
    virtual HRESULT __stdcall get_TakeScreenshotKey(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall put_TakeScreenshotKeyModifiers(Windows::System::VirtualKeyModifiers value) = 0;
    virtual HRESULT __stdcall get_TakeScreenshotKeyModifiers(Windows::System::VirtualKeyModifiers* value) = 0;
    virtual HRESULT __stdcall put_ToggleRecordingIndicatorKey(Windows::System::VirtualKey value) = 0;
    virtual HRESULT __stdcall get_ToggleRecordingIndicatorKey(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall put_ToggleRecordingIndicatorKeyModifiers(Windows::System::VirtualKeyModifiers value) = 0;
    virtual HRESULT __stdcall get_ToggleRecordingIndicatorKeyModifiers(Windows::System::VirtualKeyModifiers* value) = 0;
};};

template <> struct abi<Windows::Media::Capture::IAppCaptureAlternateShortcutKeys2>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall put_ToggleMicrophoneCaptureKey(Windows::System::VirtualKey value) = 0;
    virtual HRESULT __stdcall get_ToggleMicrophoneCaptureKey(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall put_ToggleMicrophoneCaptureKeyModifiers(Windows::System::VirtualKeyModifiers value) = 0;
    virtual HRESULT __stdcall get_ToggleMicrophoneCaptureKeyModifiers(Windows::System::VirtualKeyModifiers* value) = 0;
};};

template <> struct abi<Windows::Media::Capture::IAppCaptureAlternateShortcutKeys3>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall put_ToggleCameraCaptureKey(Windows::System::VirtualKey value) = 0;
    virtual HRESULT __stdcall get_ToggleCameraCaptureKey(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall put_ToggleCameraCaptureKeyModifiers(Windows::System::VirtualKeyModifiers value) = 0;
    virtual HRESULT __stdcall get_ToggleCameraCaptureKeyModifiers(Windows::System::VirtualKeyModifiers* value) = 0;
    virtual HRESULT __stdcall put_ToggleBroadcastKey(Windows::System::VirtualKey value) = 0;
    virtual HRESULT __stdcall get_ToggleBroadcastKey(Windows::System::VirtualKey* value) = 0;
    virtual HRESULT __stdcall put_ToggleBroadcastKeyModifiers(Windows::System::VirtualKeyModifiers value) = 0;
    virtual HRESULT __stdcall get_ToggleBroadcastKeyModifiers(Windows::System::VirtualKeyModifiers* value) = 0;
};};
...
{
    virtual HRESULT __stdcall AddStringEvent(HSTRING name, HSTRING value, Windows::Media::Capture::AppCaptureMetadataPriority priority) = 0;
    virtual HRESULT __stdcall AddInt32Event(HSTRING name, int32_t value, Windows::Media::Capture::AppCaptureMetadataPriority priority) = 0;
    virtual HRESULT __stdcall AddDoubleEvent(HSTRING name, double value, Windows::Media::Capture::AppCaptureMetadataPriority priority) = 0;
    virtual HRESULT __stdcall StartStringState(HSTRING name, HSTRING value, Windows::Media::Capture::AppCaptureMetadataPriority priority) = 0;
    virtual HRESULT __stdcall StartInt32State(HSTRING name, int32_t value, Windows::Media::Capture::AppCaptureMetadataPriority priority) = 0;
    virtual HRESULT __stdcall StartDoubleState(HSTRING name, double value, Windows::Media::Capture::AppCaptureMetadataPriority priority) = 0;
    virtual HRESULT __stdcall StopState(HSTRING name) = 0;
    virtual HRESULT __stdcall StopAllStates() = 0;
    virtual HRESULT __stdcall get_RemainingStorageBytesAvailable(uint64_t* value) = 0;
    virtual HRESULT __stdcall add_MetadataPurged(::IUnknown* handler, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MetadataPurged(event_token token) = 0;
};};

template <> struct abi<Windows::Media::Capture::IAppCaptureMicrophoneCaptureStateChangedEventArgs>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall get_State(Windows::Media::Capture::AppCaptureMicrophoneCaptureState* value) = 0;
    virtual HRESULT __stdcall get_ErrorCode(uint32_t* value) = 0;
};};
...
template <> struct abi<Windows::Media::Capture::IAppCaptureRecordOperation>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_State(Windows::Media::Capture::AppCaptureRecordingState* value) = 0;
    virtual HRESULT __stdcall get_ErrorCode(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_Duration(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_File(::IUnknown** value) = 0;
    virtual HRESULT __stdcall get_IsFileTruncated(::IUnknown** value) = 0;
    virtual HRESULT __stdcall add_StateChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_StateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_DurationGenerated(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_DurationGenerated(event_token token) = 0;
    virtual HRESULT __stdcall add_FileGenerated(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Capture::IAppCaptureServices>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall RecordTimeSpan(Windows::Foundation::DateTime startTime, Windows::Foundation::TimeSpan duration, ::IUnknown** operation) = 0;
    virtual HRESULT __stdcall get_CanCapture(bool* value) = 0;
    virtual HRESULT __stdcall get_State(::IUnknown** value) = 0;
};};
...
template <> struct abi<Windows::Media::Capture::IAppCaptureSettings>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_HistoricalBufferLengthUnit(Windows::Media::Capture::AppCaptureHistoricalBufferLengthUnit value) = 0;
    virtual HRESULT __stdcall get_HistoricalBufferLengthUnit(Windows::Media::Capture::AppCaptureHistoricalBufferLengthUnit* value) = 0;
    ...
    virtual HRESULT __stdcall put_VideoEncodingBitrateMode(Windows::Media::Capture::AppCaptureVideoEncodingBitrateMode value) = 0;
    virtual HRESULT __stdcall get_VideoEncodingBitrateMode(Windows::Media::Capture::AppCaptureVideoEncodingBitrateMode* value) = 0;
    virtual HRESULT __stdcall put_VideoEncodingResolutionMode(Windows::Media::Capture::AppCaptureVideoEncodingResolutionMode value) = 0;
    virtual HRESULT __stdcall get_VideoEncodingResolutionMode(Windows::Media::Capture::AppCaptureVideoEncodingResolutionMode* value) = 0;
...
template <> struct abi<Windows::Media::Capture::IAppCaptureSettings4>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_MicrophoneGain(double value) = 0;
    virtual HRESULT __stdcall get_MicrophoneGain(double* value) = 0;
    virtual HRESULT __stdcall put_VideoEncodingFrameRateMode(Windows::Media::Capture::AppCaptureVideoEncodingFrameRateMode value) = 0;
    virtual HRESULT __stdcall get_VideoEncodingFrameRateMode(Windows::Media::Capture::AppCaptureVideoEncodingFrameRateMode* value) = 0;
};};
...
template <> struct abi<Windows::Media::Capture::IAppCaptureState>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall put_ShouldCaptureMicrophone(bool value) = 0;
    virtual HRESULT __stdcall RestartMicrophoneCapture() = 0;
    virtual HRESULT __stdcall get_MicrophoneCaptureState(Windows::Media::Capture::AppCaptureMicrophoneCaptureState* value) = 0;
    virtual HRESULT __stdcall get_MicrophoneCaptureError(uint32_t* value) = 0;
    virtual HRESULT __stdcall add_MicrophoneCaptureStateChanged(::IUnknown* value, event_token* token) = 0;
    virtual HRESULT __stdcall remove_MicrophoneCaptureStateChanged(event_token token) = 0;
    virtual HRESULT __stdcall add_CaptureTargetClosed(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_TargetCapturePolicy(Windows::Media::Capture::GameBarTargetCapturePolicy* value) = 0;
    ...
    virtual HRESULT __stdcall add_CommandReceived(::IUnknown* value, event_token* token) = 0;
...
{
    virtual HRESULT __stdcall get_Command(Windows::Media::Capture::GameBarCommand* value) = 0;
    virtual HRESULT __stdcall get_Origin(Windows::Media::Capture::GameBarCommandOrigin* value) = 0;
};};

template <> struct abi<Windows::Media::Capture::IGameBarServicesManager>{ struct type : ::IInspectable
{
    virtual HRESULT __stdcall add_GameBarServicesCreated(::IUnknown* value, event_token* token) = 0;
...
template <> struct abi<Windows::Media::Capture::IGameBarServicesTargetInfo>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall get_AppId(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_TitleId(HSTRING* value) = 0;
    virtual HRESULT __stdcall get_DisplayMode(Windows::Media::Capture::GameBarServicesDisplayMode* value) = 0;
};};
...
template <> struct abi<Windows::Media::Capture::IScreenCapture>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall add_SourceSuspensionChanged(::IUnknown* handler, event_token* token) = 0;
