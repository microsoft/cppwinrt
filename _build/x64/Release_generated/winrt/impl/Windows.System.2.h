...
WINRT_EXPORT namespace winrt::Windows::System
{
        ...
        impl::require<User, winrt::Windows::System::IUser2>
    {
        ...
        [[deprecated("FindAllAsyncByType is deprecated and might not function consistently on all platforms. Instead, use FindAllAsync or GetDefault.")]] static auto FindAllAsync(winrt::Windows::System::UserType const& type);
        [[deprecated("FindAllAsyncByTypeAndStatus is deprecated and might not function consistently on all platforms. Instead, use FindAllAsync or GetDefault.")]] static auto FindAllAsync(winrt::Windows::System::UserType const& type, winrt::Windows::System::UserAuthenticationStatus const& status);
