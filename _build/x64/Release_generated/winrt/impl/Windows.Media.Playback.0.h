...
WINRT_EXPORT namespace winrt::Windows::Media::Playback
{
    ...
    {
        Closed [[deprecated("Use MediaPlaybackState instead of MediaPlayerState.  For more info, see MSDN.")]] = 0,
        Opening [[deprecated("Use MediaPlaybackState instead of MediaPlayerState.  For more info, see MSDN.")]] = 1,
        Buffering [[deprecated("Use MediaPlaybackState instead of MediaPlayerState.  For more info, see MSDN.")]] = 2,
        Playing [[deprecated("Use MediaPlaybackState instead of MediaPlayerState.  For more info, see MSDN.")]] = 3,
        Paused [[deprecated("Use MediaPlaybackState instead of MediaPlayerState.  For more info, see MSDN.")]] = 4,
        Stopped [[deprecated("Use MediaPlaybackState instead of MediaPlayerState.  For more info, see MSDN.")]] = 5,
    };
...
namespace winrt::impl
{
    ...
    {
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] [[nodiscard]] auto Current() const;
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] auto MessageReceivedFromBackground(winrt::Windows::Foundation::EventHandler<winrt::Windows::Media::Playback::MediaPlayerDataReceivedEventArgs> const& value) const;
        ...
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] [[nodiscard]] auto MessageReceivedFromBackground(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Windows::Media::Playback::MediaPlayerDataReceivedEventArgs> const& value) const;
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] auto MessageReceivedFromBackground(winrt::event_token const& token) const noexcept;
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] auto MessageReceivedFromForeground(winrt::Windows::Foundation::EventHandler<winrt::Windows::Media::Playback::MediaPlayerDataReceivedEventArgs> const& value) const;
        ...
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] [[nodiscard]] auto MessageReceivedFromForeground(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Windows::Media::Playback::MediaPlayerDataReceivedEventArgs> const& value) const;
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] auto MessageReceivedFromForeground(winrt::event_token const& token) const noexcept;
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] auto SendMessageToBackground(winrt::Windows::Foundation::Collections::ValueSet const& value) const;
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] auto SendMessageToForeground(winrt::Windows::Foundation::Collections::ValueSet const& value) const;
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] auto IsMediaPlaying() const;
        [[deprecated("Use MediaPlayer instead of BackgroundMediaPlayer.  For more info, see MSDN.")]] auto Shutdown() const;
    };
    ...
    {
        [[deprecated("Use MediaPlayer instead of MediaEngine. For more info, see MSDN.")]] [[nodiscard]] auto CurrentItem() const;
        [[deprecated("Use MediaPlayer instead of MediaEngine. For more info, see MSDN.")]] auto SetPlaybackSource(winrt::Windows::Media::Playback::IMediaPlaybackSource const& source) const;
    };
    ...
    struct consume_Windows_Media_Playback_IMediaPlayer
    {
        ...
        [[deprecated("Use PlaybackSession.NaturalDuration instead of NaturalDuration.  For more info, see MSDN.")]] [[nodiscard]] auto NaturalDuration() const;
        [[deprecated("Use PlaybackSession.Position instead of Position.  For more info, see MSDN.")]] [[nodiscard]] auto Position() const;
        [[deprecated("Use PlaybackSession.Position instead of Position.  For more info, see MSDN.")]] auto Position(winrt::Windows::Foundation::TimeSpan const& value) const;
        [[deprecated("Use PlaybackSession.BufferingProgress instead of BufferingProgress.  For more info, see MSDN.")]] [[nodiscard]] auto BufferingProgress() const;
        [[deprecated("Use PlaybackSession.State instead of CurrentState.  For more info, see MSDN.")]] [[nodiscard]] auto CurrentState() const;
        [[deprecated("Use PlaybackSession.CanSeek instead of CanSeek.  For more info, see MSDN.")]] [[nodiscard]] auto CanSeek() const;
        [[deprecated("Use PlaybackSession.CanPause instead of CanPause.  For more info, see MSDN.")]] [[nodiscard]] auto CanPause() const;
        [[nodiscard]] auto IsLoopingEnabled() const;
        auto IsLoopingEnabled(bool value) const;
        [[deprecated("Use PlaybackSession.IsProtected instead of IsProtected.  For more info, see MSDN.")]] [[nodiscard]] auto IsProtected() const;
        [[nodiscard]] auto IsMuted() const;
        auto IsMuted(bool value) const;
        [[deprecated("Use PlaybackSession.PlaybackRate instead of PlaybackRate.  For more info, see MSDN.")]] [[nodiscard]] auto PlaybackRate() const;
        [[deprecated("Use PlaybackSession.PlaybackRate instead of PlaybackRate.  For more info, see MSDN.")]] auto PlaybackRate(double value) const;
        [[nodiscard]] auto Volume() const;
        auto Volume(double value) const;
        [[deprecated("Use media tracks on MediaPlaybackItem instead of PlaybackMediaMarkers.  For more info, see MSDN.")]] [[nodiscard]] auto PlaybackMediaMarkers() const;
        ...
        [[deprecated("Use PlaybackSession.PlaybackStateChanged instead of CurrentStateChanged.  For more info, see MSDN.")]] auto CurrentStateChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Foundation::IInspectable> const& value) const;
        ...
        [[deprecated("Use PlaybackSession.PlaybackStateChanged instead of CurrentStateChanged.  For more info, see MSDN.")]] [[nodiscard]] auto CurrentStateChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Foundation::IInspectable> const& value) const;
        [[deprecated("Use PlaybackSession.PlaybackStateChanged instead of CurrentStateChanged.  For more info, see MSDN.")]] auto CurrentStateChanged(winrt::event_token const& token) const noexcept;
        [[deprecated("Use media tracks on MediaPlaybackItem instead of PlaybackMediaMarkers.  For more info, see MSDN.")]] auto PlaybackMediaMarkerReached(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Media::Playback::PlaybackMediaMarkerReachedEventArgs> const& value) const;
        ...
        [[deprecated("Use media tracks on MediaPlaybackItem instead of PlaybackMediaMarkers.  For more info, see MSDN.")]] [[nodiscard]] auto PlaybackMediaMarkerReached(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Media::Playback::PlaybackMediaMarkerReachedEventArgs> const& value) const;
        [[deprecated("Use media tracks on MediaPlaybackItem instead of PlaybackMediaMarkers.  For more info, see MSDN.")]] auto PlaybackMediaMarkerReached(winrt::event_token const& token) const noexcept;
        [[deprecated("Use PlaybackSession.PlaybackRateChanged instead of MediaPlayerRateChanged.  For more info, see MSDN.")]] auto MediaPlayerRateChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Media::Playback::MediaPlayerRateChangedEventArgs> const& value) const;
        ...
        [[deprecated("Use PlaybackSession.PlaybackRateChanged instead of MediaPlayerRateChanged.  For more info, see MSDN.")]] [[nodiscard]] auto MediaPlayerRateChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Media::Playback::MediaPlayerRateChangedEventArgs> const& value) const;
        [[deprecated("Use PlaybackSession.PlaybackRateChanged instead of MediaPlayerRateChanged.  For more info, see MSDN.")]] auto MediaPlayerRateChanged(winrt::event_token const& token) const noexcept;
        ...
        [[deprecated("Use PlaybackSession.SeekCompleted instead of SeekCompleted.  For more info, see MSDN.")]] auto SeekCompleted(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Foundation::IInspectable> const& value) const;
        ...
        [[deprecated("Use PlaybackSession.SeekCompleted instead of SeekCompleted.  For more info, see MSDN.")]] [[nodiscard]] auto SeekCompleted(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Foundation::IInspectable> const& value) const;
        [[deprecated("Use PlaybackSession.SeekCompleted instead of SeekCompleted.  For more info, see MSDN.")]] auto SeekCompleted(winrt::event_token const& token) const noexcept;
        [[deprecated("Use PlaybackSession.BufferingStarted instead of BufferingStarted.  For more info, see MSDN.")]] auto BufferingStarted(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Foundation::IInspectable> const& value) const;
        ...
        [[deprecated("Use PlaybackSession.BufferingStarted instead of BufferingStarted.  For more info, see MSDN.")]] [[nodiscard]] auto BufferingStarted(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Foundation::IInspectable> const& value) const;
        [[deprecated("Use PlaybackSession.BufferingStarted instead of BufferingStarted.  For more info, see MSDN.")]] auto BufferingStarted(winrt::event_token const& token) const noexcept;
        [[deprecated("Use PlaybackSession.BufferingEnded instead of BufferingEnded.  For more info, see MSDN.")]] auto BufferingEnded(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Foundation::IInspectable> const& value) const;
        ...
        [[deprecated("Use PlaybackSession.BufferingEnded instead of BufferingEnded.  For more info, see MSDN.")]] [[nodiscard]] auto BufferingEnded(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Playback::MediaPlayer, winrt::Windows::Foundation::IInspectable> const& value) const;
        [[deprecated("Use PlaybackSession.BufferingEnded instead of BufferingEnded.  For more info, see MSDN.")]] auto BufferingEnded(winrt::event_token const& token) const noexcept;
        auto Play() const;
        auto Pause() const;
        [[deprecated("Use Source instead of SetUriSource.  For more info, see MSDN.")]] auto SetUriSource(winrt::Windows::Foundation::Uri const& value) const;
    };
    ...
    struct consume_Windows_Media_Playback_IMediaPlayerSource
    {
        ...
        [[deprecated("Use Source instead of SetFileSource.  For more info, see MSDN.")]] auto SetFileSource(winrt::Windows::Storage::IStorageFile const& file) const;
        [[deprecated("Use Source instead of SetStreamSource.  For more info, see MSDN.")]] auto SetStreamSource(winrt::Windows::Storage::Streams::IRandomAccessStream const& stream) const;
        [[deprecated("Use Source instead of SetMediaSource.  For more info, see MSDN.")]] auto SetMediaSource(winrt::Windows::Media::Core::IMediaSource const& source) const;
    };
