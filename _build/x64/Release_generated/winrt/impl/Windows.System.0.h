...
namespace winrt::impl
{
    ...
    struct consume_Windows_System_IUserStatics
    {
        ...
        [[deprecated("FindAllAsyncByType is deprecated and might not function consistently on all platforms. Instead, use FindAllAsync or GetDefault.")]] auto FindAllAsync(winrt::Windows::System::UserType const& type) const;
        [[deprecated("FindAllAsyncByTypeAndStatus is deprecated and might not function consistently on all platforms. Instead, use FindAllAsync or GetDefault.")]] auto FindAllAsync(winrt::Windows::System::UserType const& type, winrt::Windows::System::UserAuthenticationStatus const& status) const;
