...
namespace winrt::impl
{
    ...
    struct consume_Windows_Media_Capture_IMediaCapture
    {
        ...
        [[deprecated("AddEffectAsync might not be available in future versions of Windows. Starting with Windows Threshold, use AddAudioEffectAsync and AddVideoEffectAsync instead")]] auto AddEffectAsync(winrt::Windows::Media::Capture::MediaStreamType const& mediaStreamType, param::hstring const& effectActivationID, winrt::Windows::Foundation::Collections::IPropertySet const& effectSettings) const;
    ...
    struct consume_Windows_Media_Capture_IMediaCaptureVideoProfileMediaDescription
    {
        ...
        [[deprecated("IsVariablePhotoSequenceSupported might not be available in the next major update following Windows 10, version 1709")]] [[nodiscard]] auto IsVariablePhotoSequenceSupported() const;
        [[deprecated("IsHdrVideoSupported might not be available in the next major update following Windows 10, version 1709")]] [[nodiscard]] auto IsHdrVideoSupported() const;
    };
