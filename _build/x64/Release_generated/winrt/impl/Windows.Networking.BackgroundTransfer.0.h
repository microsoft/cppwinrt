...
namespace winrt::impl
{
    ...
    struct consume_Windows_Networking_BackgroundTransfer_IBackgroundDownloaderStaticMethods
    {
        ...
        [[deprecated("GetCurrentDownloadsAsync(group) may be altered or unavailable for releases after Windows 8.1. Instead, use GetCurrentDownloadsForTransferGroupAsync.")]] auto GetCurrentDownloadsAsync(param::hstring const& group) const;
    };
    ...
    {
        [[deprecated("RequestUnconstrainedDownloadsAsync is deprecated and may not work on all platforms. For more info, see MSDN.")]] auto RequestUnconstrainedDownloadsAsync(param::async_iterable<winrt::Windows::Networking::BackgroundTransfer::DownloadOperation> const& operations) const;
    };
    ...
    struct consume_Windows_Networking_BackgroundTransfer_IBackgroundTransferBase
    {
        ...
        [[deprecated("Group may be altered or unavailable for releases after Windows 8.1. Instead, use TransferGroup.")]] [[nodiscard]] auto Group() const;
        [[deprecated("Group may be altered or unavailable for releases after Windows 8.1. Instead, use TransferGroup.")]] auto Group(param::hstring const& value) const;
    ...
    struct consume_Windows_Networking_BackgroundTransfer_IBackgroundUploaderStaticMethods
    {
        ...
        [[deprecated("GetCurrentUploadsAsync(group) may be altered or unavailable for releases after Windows 8.1. Instead, use GetCurrentUploadsForTransferGroupAsync.")]] auto GetCurrentUploadsAsync(param::hstring const& group) const;
    };
    ...
    {
        [[deprecated("RequestUnconstrainedUploadsAsync is deprecated and may not work on all platforms. For more info, see MSDN.")]] auto RequestUnconstrainedUploadsAsync(param::async_iterable<winrt::Windows::Networking::BackgroundTransfer::UploadOperation> const& operations) const;
    };
    ...
    {
        [[deprecated("IsUnconstrained is deprecated and may not work on all platforms. For more info, see MSDN.")]] [[nodiscard]] auto IsUnconstrained() const;
    };
