...
namespace winrt::impl
{
    ...
    {
        [[deprecated("Latitude may be altered or unavailable after Windows 8.1. Instead, use Point.Position.Latitude")]] [[nodiscard]] auto Latitude() const;
        [[deprecated("Longitude may be altered or unavailable after Windows 8.1. Instead, use Point.Position.Longitude")]] [[nodiscard]] auto Longitude() const;
        [[deprecated("Altitude may be altered or unavailable after Windows 8.1. Instead, use Point.Position.Altitude")]] [[nodiscard]] auto Altitude() const;
    ...
    struct consume_Windows_Devices_Geolocation_IGeolocatorStatics
    {
        ...
        [[deprecated("GetGeopositionHistoryAsync is deprecated and might not work on all platforms. For more info, see MSDN.")]] auto GetGeopositionHistoryAsync(winrt::Windows::Foundation::DateTime const& startTime) const;
        [[deprecated("GetGeopositionHistoryWithDurationAsync is deprecated and might not work on all platforms. For more info, see MSDN.")]] auto GetGeopositionHistoryAsync(winrt::Windows::Foundation::DateTime const& startTime, winrt::Windows::Foundation::TimeSpan const& duration) const;
    };
