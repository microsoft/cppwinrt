...
namespace winrt::impl
{
    ...
    {
        [[deprecated("Not supported starting in windows 10")]] [[nodiscard]] auto EffectsProviderThumbnail() const;
        [[deprecated("Not supported starting in windows 10")]] [[nodiscard]] auto EffectsProviderSettingsLabel() const;
        [[deprecated("Not supported starting in windows 10")]] auto ShowSettingsUI() const;
    };
