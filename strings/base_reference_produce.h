...
WINRT_EXPORT namespace winrt::impl
{
    ...
    // Pre-computed pinterface_guid specializations for standard IReference<T> and IReferenceArray<T> types.
    // These avoid costly constexpr SHA1 computation at compile time.
    // Wrapped in extern "C++" so that identical specializations across modules merge.
    // #ifndef guards match those emitted by the code generator, preventing redefinition
    // when both base_reference_produce.h and a generated .0.h define the same specialization.
} // winrt::impl
...
{
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__uint8_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__uint8_t_
    template <> struct pinterface_guid<Windows::Foundation::IReference<std::uint8_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0xE5198CC8,0x2873,0x55F5,{ 0xB0,0xA1,0x84,0xFF,0x9E,0x4A,0xAD,0x62 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__int16_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__int16_t_
    template <> struct pinterface_guid<Windows::Foundation::IReference<std::int16_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x6EC9E41B,0x6709,0x5647,{ 0x99,0x18,0xA1,0x27,0x01,0x10,0xFC,0x4E } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__uint16_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__uint16_t_
    template <> struct pinterface_guid<Windows::Foundation::IReference<std::uint16_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x5AB7D2C3,0x6B62,0x5E71,{ 0xA4,0xB6,0x2D,0x49,0xC4,0xF2,0x38,0xFD } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__int32_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__int32_t_
    template <> struct pinterface_guid<Windows::Foundation::IReference<std::int32_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x548CEFBD,0xBC8A,0x5FA0,{ 0x8D,0xF2,0x95,0x74,0x40,0xFC,0x8B,0xF4 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__uint32_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__uint32_t_
    template <> struct pinterface_guid<Windows::Foundation::IReference<std::uint32_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x513EF3AF,0xE784,0x5325,{ 0xA9,0x1E,0x97,0xC2,0xB8,0x11,0x1C,0xF3 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__int64_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__int64_t_
    template <> struct pinterface_guid<Windows::Foundation::IReference<std::int64_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x4DDA9E24,0xE69F,0x5C6A,{ 0xA0,0xA6,0x93,0x42,0x73,0x65,0xAF,0x2A } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__uint64_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_std__uint64_t_
    template <> struct pinterface_guid<Windows::Foundation::IReference<std::uint64_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x6755E376,0x53BB,0x568B,{ 0xA1,0x1D,0x17,0x23,0x98,0x68,0x30,0x9E } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_float_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_float_
    template <> struct pinterface_guid<Windows::Foundation::IReference<float>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x719CC2BA,0x3E76,0x5DEF,{ 0x9F,0x1A,0x38,0xD8,0x5A,0x14,0x5E,0xA8 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_double_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_double_
    template <> struct pinterface_guid<Windows::Foundation::IReference<double>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x2F2D6C29,0x5473,0x5F3E,{ 0x92,0xE7,0x96,0x57,0x2B,0xB9,0x90,0xE2 } }; };
#endif
...
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_char16_t_
    template <> struct pinterface_guid<Windows::Foundation::IReference<char16_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0xFB393EF3,0xBBAC,0x5BD5,{ 0x91,0x44,0x84,0xF2,0x35,0x76,0xF4,0x15 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_bool_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_bool_
    template <> struct pinterface_guid<Windows::Foundation::IReference<bool>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x3C00FD60,0x2950,0x5939,{ 0xA2,0x1A,0x2D,0x12,0xC5,0xA0,0x1B,0x8A } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__hstring_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__hstring_
    template <> struct pinterface_guid<Windows::Foundation::IReference<hstring>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0xFD416DFB,0x2A07,0x52EB,{ 0xAA,0xE3,0xDF,0xCE,0x14,0x11,0x6C,0x05 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__guid_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__guid_
    template <> struct pinterface_guid<Windows::Foundation::IReference<guid>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x7D50F649,0x632C,0x51F9,{ 0x84,0x9A,0xEE,0x49,0x42,0x89,0x33,0xEA } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__DateTime_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__DateTime_
    template <> struct pinterface_guid<Windows::Foundation::IReference<Windows::Foundation::DateTime>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x5541D8A7,0x497C,0x5AA4,{ 0x86,0xFC,0x77,0x13,0xAD,0xBF,0x2A,0x2C } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__TimeSpan_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__TimeSpan_
    template <> struct pinterface_guid<Windows::Foundation::IReference<Windows::Foundation::TimeSpan>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x604D0C4C,0x91DE,0x5C2A,{ 0x93,0x5F,0x36,0x2F,0x13,0xEA,0xF8,0x00 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__Point_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__Point_
    template <> struct pinterface_guid<Windows::Foundation::IReference<Windows::Foundation::Point>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x84F14C22,0xA00A,0x5272,{ 0x8D,0x3D,0x82,0x11,0x2E,0x66,0xDF,0x00 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__Size_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__Size_
    template <> struct pinterface_guid<Windows::Foundation::IReference<Windows::Foundation::Size>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x61723086,0x8E53,0x5276,{ 0x9F,0x36,0x2A,0x4B,0xB9,0x3E,0x2B,0x75 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__Rect_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReference_winrt__Windows__Foundation__Rect_
    template <> struct pinterface_guid<Windows::Foundation::IReference<Windows::Foundation::Rect>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x80423F11,0x054F,0x5EAC,{ 0xAF,0xD3,0x63,0xB6,0xCE,0x15,0xE7,0x7B } }; };
#endif

#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__uint8_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__uint8_t_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<std::uint8_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x2AF22683,0x3734,0x56D0,{ 0xA6,0x0E,0x68,0x8C,0xC8,0x5D,0x16,0x19 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__int16_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__int16_t_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<std::int16_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x912F8FD7,0xADC0,0x5D60,{ 0xA8,0x96,0x7E,0xD7,0x60,0x89,0xCC,0x5B } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__uint16_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__uint16_t_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<std::uint16_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x6624A2DD,0x83F7,0x519C,{ 0x9D,0x55,0xBB,0x1F,0x65,0x60,0x45,0x6B } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__int32_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__int32_t_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<std::int32_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0xA6D080A5,0xB087,0x5BC2,{ 0x9A,0x9F,0x5C,0xD6,0x87,0xB4,0xD1,0xF7 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__uint32_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__uint32_t_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<std::uint32_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x97374B68,0xEB87,0x56CC,{ 0xB1,0x8E,0x27,0xEF,0x0F,0x9C,0xFC,0x0C } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__int64_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__int64_t_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<std::int64_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x6E333271,0x2E2A,0x5955,{ 0x87,0x90,0x83,0x6C,0x76,0xEE,0x53,0xB6 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__uint64_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_std__uint64_t_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<std::uint64_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x38B60434,0xD67C,0x523E,{ 0x9D,0x0E,0x24,0xD6,0x43,0x41,0x10,0x73 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_float_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_float_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<float>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x6AB1EA83,0xCB41,0x5F99,{ 0x92,0xCC,0x23,0xBD,0x43,0x36,0xA1,0xFB } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_double_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_double_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<double>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0xD301F253,0xE0A3,0x5D2B,{ 0x9A,0x41,0xA4,0xD6,0x2B,0xEC,0x46,0x23 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_char16_t_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_char16_t_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<char16_t>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0xA4095AAB,0xEB7D,0x5782,{ 0x8F,0xAD,0x16,0x09,0xDE,0xA2,0x49,0xAD } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_bool_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_bool_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<bool>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0xE8E72666,0x48CC,0x593F,{ 0xBA,0x85,0x26,0x63,0x49,0x69,0x56,0xE3 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__hstring_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__hstring_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<hstring>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x0385688E,0xE3C7,0x5C5E,{ 0xA3,0x89,0x55,0x24,0xED,0xE3,0x49,0xF1 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__IInspectable_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__IInspectable_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<Windows::Foundation::IInspectable>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x9CD7A84F,0x0C80,0x59C5,{ 0xB4,0x4E,0x97,0x78,0x41,0xBB,0x43,0xD9 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__guid_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__guid_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<guid>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0xEECF9838,0xC1C2,0x5B4A,{ 0x97,0x6F,0xCE,0xC2,0x61,0xAE,0x1D,0x55 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__DateTime_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__DateTime_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<Windows::Foundation::DateTime>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x1B8E9594,0x588E,0x5A07,{ 0x9E,0x65,0x07,0x31,0xA4,0xC9,0xA2,0xDB } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__TimeSpan_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__TimeSpan_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<Windows::Foundation::TimeSpan>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0xAD73197D,0x2CFA,0x57A6,{ 0x89,0x93,0x9F,0xAC,0x40,0xFE,0xB7,0x91 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__Point_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__Point_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<Windows::Foundation::Point>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x39313214,0x5C7D,0x599D,{ 0xAE,0x5A,0x17,0xD9,0xD6,0x49,0x22,0x58 } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__Size_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__Size_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<Windows::Foundation::Size>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x3B40E9D4,0xE0C3,0x56F6,{ 0xB8,0x8B,0xE5,0x05,0xEB,0x73,0x75,0x7B } }; };
#endif
#ifndef WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__Rect_
#define WINRT_IMPL_PINTERFACE_GUID_winrt__Windows__Foundation__IReferenceArray_winrt__Windows__Foundation__Rect_
    template <> struct pinterface_guid<Windows::Foundation::IReferenceArray<Windows::Foundation::Rect>>
    { static constexpr bool precomputed = true; static constexpr guid value{ 0x8A444256,0xD661,0x5E9A,{ 0xA7,0x2B,0xD8,0xF1,0xD7,0x96,0x2D,0x0C } }; };
#endif
} // winrt::impl
} // extern "C++"
