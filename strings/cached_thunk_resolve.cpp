// cached_thunk_resolve.cpp - Bridge from ASM thunk stubs to C++ resolve logic
//
...
extern "C" void* winrt_cached_resolve_thunk(winrt::impl::interface_thunk const* thunk)
{
