; thunk_stubs_x86.asm - x86 thunk stubs for interface caching
;
...
vtable_entry macro idx
    dd winrt_fast_thunk_stub_&idx&
endm

public winrt_fast_thunk_vtable
winrt_fast_thunk_vtable label dword

dd winrt_thunk_qi
dd winrt_thunk_addref
dd winrt_thunk_release
