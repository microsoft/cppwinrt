...
{
    template <> inline constexpr auto& name_v<Windows::Foundation::Point> = "Windows.Foundation.Point";
    template <> inline constexpr auto& name_v<Windows::Foundation::Size> = "Windows.Foundation.Size";
    template <> inline constexpr auto& name_v<Windows::Foundation::Rect> = "Windows.Foundation.Rect";
    ...
    template <> inline constexpr auto& name_v<Windows::Foundation::Numerics::float2> = "Windows.Foundation.Numerics.Vector2";
    template <> inline constexpr auto& name_v<Windows::Foundation::Numerics::float3> = "Windows.Foundation.Numerics.Vector3";
    template <> inline constexpr auto& name_v<Windows::Foundation::Numerics::float4> = "Windows.Foundation.Numerics.Vector4";
    template <> inline constexpr auto& name_v<Windows::Foundation::Numerics::float3x2> = "Windows.Foundation.Numerics.Matrix3x2";
    template <> inline constexpr auto& name_v<Windows::Foundation::Numerics::float4x4> = "Windows.Foundation.Numerics.Matrix4x4";
    template <> inline constexpr auto& name_v<Windows::Foundation::Numerics::quaternion> = "Windows.Foundation.Numerics.Quaternion";
    template <> inline constexpr auto& name_v<Windows::Foundation::Numerics::plane> = "Windows.Foundation.Numerics.Plane";
