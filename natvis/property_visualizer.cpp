...
HRESULT property_visualizer::SetValueAsString(_In_ DkmString* pValue, _In_ UINT32 Timeout, _Deref_out_opt_ DkmString** ppErrorText)
{
    // Forward this on to the EE.
...
HRESULT property_visualizer::GetUnderlyingString(_Deref_out_opt_ DkmString** ppStringValue)
{
    // Forward this on to the EE.
