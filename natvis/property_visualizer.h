...
struct __declspec(uuid("87feab93-47a3-4f55-b48b-a29317fa52da")) property_visualizer : winrt::implements<property_visualizer, ::IUnknown>
{
    property_visualizer(
    ...
    HRESULT SetValueAsString(_In_ Microsoft::VisualStudio::Debugger::DkmString* pValue, _In_ UINT32 Timeout, _Deref_out_opt_ Microsoft::VisualStudio::Debugger::DkmString** ppErrorText);
