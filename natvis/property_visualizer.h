...
{
    property_visualizer(_In_ Microsoft::VisualStudio::Debugger::Evaluation::DkmChildVisualizedExpression* pVisualizedExpression,
    ...
    HRESULT GetItems(_In_ Microsoft::VisualStudio::Debugger::Evaluation::DkmEvaluationResultEnumContext* pEnumContext,
    ...
    HRESULT SetValueAsString(_In_ Microsoft::VisualStudio::Debugger::DkmString* pValue,
                             _In_ UINT32 Timeout,
