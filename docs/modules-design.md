...
`WINRT_EXPORT` is defined in `base_macros.h` (generated as `winrt/base_macros.h`):
...
|-|-|-|
| `winrt/base_macros.h` | Always with `-base` | Macros for module builds (WINRT_EXPORT, etc.) |
