...
namespace DX
{
    ...
    {
    public:
        CameraResources(winrt::Windows::Graphics::Holographic::HolographicCamera holographicCamera);
        ...
        ID3D11RenderTargetView* GetBackBufferRenderTargetView()     const { return get(m_d3dRenderTargetView); }
        ID3D11DepthStencilView* GetDepthStencilView()               const { return get(m_d3dDepthStencilView); }
        ID3D11Texture2D*        GetBackBufferTexture2D()            const { return get(m_d3dBackBuffer); }
