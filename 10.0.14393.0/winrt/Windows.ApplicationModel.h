...
struct produce<D, Windows::ApplicationModel::IFullTrustProcessLauncherStatics> : produce_base<D, Windows::ApplicationModel::IFullTrustProcessLauncherStatics>
{
    HRESULT __stdcall abi_LaunchFullTrustProcessForCurrentAppAsync(abi_arg_out<Windows::Foundation::IAsyncAction> asyncAction) noexcept override
    {
        try
        {
            *asyncAction = detach(this->shim().LaunchFullTrustProcessForCurrentAppAsync());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall abi_LaunchFullTrustProcessForCurrentAppWithParametersAsync(abi_arg_in<hstring> parameterGroupId, abi_arg_out<Windows::Foundation::IAsyncAction> asyncAction) noexcept override
    {
        try
        {
            *asyncAction = detach(this->shim().LaunchFullTrustProcessForCurrentAppAsync(*reinterpret_cast<const hstring *>(&parameterGroupId)));
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall abi_LaunchFullTrustProcessForAppAsync(abi_arg_in<hstring> fullTrustPackageRelativeAppId, abi_arg_out<Windows::Foundation::IAsyncAction> asyncAction) noexcept override
    {
        try
        {
            *asyncAction = detach(this->shim().LaunchFullTrustProcessForAppAsync(*reinterpret_cast<const hstring *>(&fullTrustPackageRelativeAppId)));
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall abi_LaunchFullTrustProcessForAppWithParametersAsync(abi_arg_in<hstring> fullTrustPackageRelativeAppId, abi_arg_in<hstring> parameterGroupId, abi_arg_out<Windows::Foundation::IAsyncAction> asyncAction) noexcept override
    {
        try
        {
            *asyncAction = detach(this->shim().LaunchFullTrustProcessForAppAsync(*reinterpret_cast<const hstring *>(&fullTrustPackageRelativeAppId), *reinterpret_cast<const hstring *>(&parameterGroupId)));
            return S_OK;
        }
        catch (...)
        {
...
struct produce<D, Windows::ApplicationModel::IStartupTask> : produce_base<D, Windows::ApplicationModel::IStartupTask>
{
    HRESULT __stdcall abi_RequestEnableAsync(abi_arg_out<Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::StartupTaskState>> operation) noexcept override
    {
        try
        {
            *operation = detach(this->shim().RequestEnableAsync());
            return S_OK;
        }
        catch (...)
        {
...
struct produce<D, Windows::ApplicationModel::IStartupTaskStatics> : produce_base<D, Windows::ApplicationModel::IStartupTaskStatics>
{
    HRESULT __stdcall abi_GetForCurrentPackageAsync(abi_arg_out<Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::StartupTask>>> operation) noexcept override
    {
        try
        {
            *operation = detach(this->shim().GetForCurrentPackageAsync());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall abi_GetAsync(abi_arg_in<hstring> taskId, abi_arg_out<Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::StartupTask>> operation) noexcept override
    {
        try
        {
            *operation = detach(this->shim().GetAsync(*reinterpret_cast<const hstring *>(&taskId)));
            return S_OK;
        }
        catch (...)
        {
...
template <typename D> Windows::Foundation::IAsyncAction impl_IFullTrustProcessLauncherStatics<D>::LaunchFullTrustProcessForCurrentAppAsync() const
{
    ...
    check_hresult(static_cast<const IFullTrustProcessLauncherStatics &>(static_cast<const D &>(*this))->abi_LaunchFullTrustProcessForCurrentAppAsync(put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(static_cast<const IFullTrustProcessLauncherStatics &>(static_cast<const D &>(*this))->abi_LaunchFullTrustProcessForCurrentAppWithParametersAsync(get(parameterGroupId), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(static_cast<const IFullTrustProcessLauncherStatics &>(static_cast<const D &>(*this))->abi_LaunchFullTrustProcessForAppAsync(get(fullTrustPackageRelativeAppId), put(asyncAction)));
    return asyncAction;
}
...
{
    Windows::Foundation::IAsyncAction asyncAction;
    check_hresult(static_cast<const IFullTrustProcessLauncherStatics &>(static_cast<const D &>(*this))->abi_LaunchFullTrustProcessForAppWithParametersAsync(get(fullTrustPackageRelativeAppId), get(parameterGroupId), put(asyncAction)));
    return asyncAction;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::StartupTaskState> impl_IStartupTask<D>::RequestEnableAsync() const
{
    ...
    check_hresult(static_cast<const IStartupTask &>(static_cast<const D &>(*this))->abi_RequestEnableAsync(put(operation)));
    return operation;
}

template <typename D> void impl_IStartupTask<D>::Disable() const
{
    check_hresult(static_cast<const IStartupTask &>(static_cast<const D &>(*this))->abi_Disable());
}
...
template <typename D> Windows::ApplicationModel::StartupTaskState impl_IStartupTask<D>::State() const
{
    ...
    check_hresult(static_cast<const IStartupTask &>(static_cast<const D &>(*this))->get_State(&value));
    return value;
}
...
{
    hstring value;
    check_hresult(static_cast<const IStartupTask &>(static_cast<const D &>(*this))->get_TaskId(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::StartupTask>> impl_IStartupTaskStatics<D>::GetForCurrentPackageAsync() const
{
    ...
    check_hresult(static_cast<const IStartupTaskStatics &>(static_cast<const D &>(*this))->abi_GetForCurrentPackageAsync(put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::StartupTask> impl_IStartupTaskStatics<D>::GetAsync(hstring_ref taskId) const
{
    ...
    check_hresult(static_cast<const IStartupTaskStatics &>(static_cast<const D &>(*this))->abi_GetAsync(get(taskId), put(operation)));
    return operation;
}

template <typename D> void impl_ICameraApplicationManagerStatics<D>::ShowInstalledApplicationsUI() const
{
    check_hresult(static_cast<const ICameraApplicationManagerStatics &>(static_cast<const D &>(*this))->abi_ShowInstalledApplicationsUI());
}
