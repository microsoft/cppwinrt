...
struct WINRT_EBO impl_IEnterpriseEnrollmentManager
{
    ...
    Windows::Foundation::IAsyncOperation<Windows::Phone::Management::Deployment::EnterpriseEnrollmentResult> RequestEnrollmentAsync(hstring_ref enrollmentToken) const;
...
{
    Windows::Foundation::IAsyncOperationWithProgress<Windows::Phone::Management::Deployment::PackageInstallResult, uint32_t> AddPackageAsync(hstring_ref title, const Windows::Foundation::Uri & sourceLocation) const;
    Windows::Foundation::IAsyncOperationWithProgress<Windows::Phone::Management::Deployment::PackageInstallResult, uint32_t> AddPackageAsync(hstring_ref title, const Windows::Foundation::Uri & sourceLocation, hstring_ref instanceId, hstring_ref offerId, const Windows::Foundation::Uri & license) const;
...
{
    Windows::Foundation::IAsyncOperationWithProgress<Windows::Phone::Management::Deployment::PackageInstallResult, uint32_t> RemovePackageAsync(hstring_ref packageFullName, Windows::Management::Deployment::RemovalOptions removalOptions) const;
    ...
    impl::consume<IEnterprise>
{
    ...
    auto operator->() const noexcept { return ptr<IEnterprise>(m_ptr); }
};
    ...
    impl::consume<IEnterpriseEnrollmentManager>
{
    ...
    auto operator->() const noexcept { return ptr<IEnterpriseEnrollmentManager>(m_ptr); }
};
    ...
    impl::consume<IEnterpriseEnrollmentResult>
{
    ...
    auto operator->() const noexcept { return ptr<IEnterpriseEnrollmentResult>(m_ptr); }
};
    ...
    impl::consume<IInstallationManagerStatics>
{
    ...
    auto operator->() const noexcept { return ptr<IInstallationManagerStatics>(m_ptr); }
};
    ...
    impl::consume<IInstallationManagerStatics2>
{
    ...
    auto operator->() const noexcept { return ptr<IInstallationManagerStatics2>(m_ptr); }
};
    ...
    impl::consume<IPackageInstallResult>
{
    ...
    auto operator->() const noexcept { return ptr<IPackageInstallResult>(m_ptr); }
};
    ...
    impl::consume<IPackageInstallResult2>
{
    ...
    auto operator->() const noexcept { return ptr<IPackageInstallResult2>(m_ptr); }
};
