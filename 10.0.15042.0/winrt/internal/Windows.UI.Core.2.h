...
struct ISystemNavigationCloseRequestedEventArgs :
    Windows::Foundation::IInspectable,
    impl::consume<ISystemNavigationCloseRequestedEventArgs>
{
    ISystemNavigationCloseRequestedEventArgs(std::nullptr_t = nullptr) noexcept {}
};
...
struct ISystemNavigationManager3 :
    Windows::Foundation::IInspectable,
    impl::consume<ISystemNavigationManager3>
{
    ISystemNavigationManager3(std::nullptr_t = nullptr) noexcept {}
};
